...
const VALID_CATEGORIES: PluginCategory[] = [
  "ai", "data", "integration", "utility",
  "automation", "analytics", "communication",
  "development", "other",
];
...
const VALID_PERMISSIONS: PluginPermission[] = [
  ...
  "env", "secrets", "filesystem", "shell",
  "api:workflows", "api:executions", "api:users",
  "ui:sidebar", "ui:toolbar", "ui:panel", "ui:modal",
];

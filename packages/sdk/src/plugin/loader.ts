  ...
  private createLogger(pluginId: string): PluginLogger {
    ...
    return {
      debug: (message: string, ...args: unknown[]) =>
        baseLogger?.debug(`${prefix} ${message}`, ...args) ?? console.debug(`${prefix} ${message}`, ...args),
      info: (message: string, ...args: unknown[]) =>
        baseLogger?.info(`${prefix} ${message}`, ...args) ?? console.info(`${prefix} ${message}`, ...args),
      warn: (message: string, ...args: unknown[]) =>
        baseLogger?.warn(`${prefix} ${message}`, ...args) ?? console.warn(`${prefix} ${message}`, ...args),
      error: (message: string, ...args: unknown[]) =>
        baseLogger?.error(`${prefix} ${message}`, ...args) ?? console.error(`${prefix} ${message}`, ...args),
    };
  }
}

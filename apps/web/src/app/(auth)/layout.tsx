...
export default function AuthLayout({
 ...
 <a href="/terms" className="hover:text-muted-foreground/60 transition-colors">Terms of Service</a>
 <span>·</span>
 <a href="/privacy" className="hover:text-muted-foreground/60 transition-colors">Privacy Policy</a>
 <span>·</span>
 <span>©2026</span>
 </div>
 </div>

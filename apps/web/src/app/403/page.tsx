...
// 常见原因提示
const commonReasons = [
  { icon: Shield, text: "您的账户权限级别不足" },
  { icon: Users, text: "该资源仅限特定用户组访问" },
  { icon: Lock, text: "登录会话可能已过期" },
];
    ...
    <div className="min-h-screen bg-background flex flex-col overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(245,158,11,0.5) 0%, transparent 60%)",
          }}
        />
      </div>
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-16">
        <div className="max-w-md mx-auto text-center">
          ...
          >
            抱歉，您没有访问此页面的权限。请尝试重新登录、切换账户，或联系管理员获取访问权限。
          </p>
            ...
            <div className="flex items-start gap-4 text-left">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mb-3">
                  如果您认为这是一个错误，或需要申请访问权限，我们的支持团队随时为您服务
                </p>
                <Link href="/contact">
                  <Button
                    variant="outline"

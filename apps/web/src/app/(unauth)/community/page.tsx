          ...
          <div className="grid md:grid-cols-3 gap-6">
            {platforms.map((platform) => (
              ...
              >
                ...
                <h3 className="text-[14px] font-semibold text-foreground mb-2">{platform.name}</h3>
                <p className="text-[12px] text-foreground-lighter mb-4">{platform.description}</p>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[12px] text-foreground-lighter mb-1">{event.description}</p>
                ...
                <Button
                  variant="outline"
                  size="sm"
                  className="shrink-0 rounded-full border-border/50 hover:bg-surface-200/50"
                >
                  Learn More
                </Button>
              </div>

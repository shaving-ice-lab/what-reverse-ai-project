...
const pressReleases = [
  {
    id: "1",
    title: "AgentFlow 完成 B 轮融资，估值达 5 亿美元",
    date: "2026-01-15",
    category: "融资",
    excerpt:
      "AgentFlow 宣布完成 5000 万美元 B 轮融资，由红杉资本领投，将用于扩大研发团队和全球市场拓展。",
    featured: true,
  },
  {
    id: "2",
    title: "AgentFlow 推出企业版，服务全球 500 强企业",
    date: "2026-01-10",
    category: "产品",
    excerpt:
      "面向大型企业推出专属解决方案，提供私有化部署、SOC 2 认证和专属技术支持。",
    featured: true,
  },
  {
    id: "3",
    title: "AgentFlow 用户突破 100 万，月活跃用户增长 300%",
    date: "2025-12-20",
    category: "里程碑",
    excerpt:
      "平台注册用户突破百万大关，月活跃用户数同比增长 300%，创下行业新纪录。",
    featured: false,
  },
  {
    id: "4",
    ...
    category: "合作",
    excerpt:
      "双方将在 AI 基础设施、模型服务等领域展开深度合作，共同推动企业智能化转型。",
    featured: false,
  },
  {
    id: "5",
    title: "AgentFlow 荣获 2025 年度最佳 AI 工具奖",
    date: "2025-11-28",
    category: "荣誉",
    excerpt:
      "在全球 AI 工具评选中脱颖而出，获得年度最佳 AI 工作流工具奖项。",
    featured: false,
  },
  {
    id: "6",
    ...
    category: "开源",
    excerpt:
      "AgentFlow 将工作流执行引擎开源，上线仅一周即获得超过 10,000 GitHub Star。",
    featured: false,
  },
];
...
const mediaAssets = [
  {
    title: "Logo 资源包",
    description: "包含 SVG、PNG、PDF 格式的官方 Logo",
    icon: Image,
    size: "4.2 MB",
    format: "ZIP",
  },
...
export default function PressPage() {
  ...
  const categories = ["all", "融资", "产品", "里程碑", "合作", "荣誉", "开源"];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="lobe-section-header mb-8">
            ...
            <h2 className="text-[20px]">最新动态</h2>
          </div>
      ...
      <section id="press-releases" className="py-16 px-6 bg-gradient-section">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <h2 className="text-[20px] font-semibold text-foreground">新闻稿</h2>
      ...
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-[20px] font-semibold text-foreground mb-8">媒体报道</h2>
      ...
      <section id="media-assets" className="py-16 px-6 bg-gradient-section">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-[20px] font-semibold text-foreground">媒体资源</h2>
            <Link href="/brand">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="p-8 rounded-2xl bg-surface-100/30 border border-border/30 text-center">
            ...
            <p className="text-[13px] text-foreground-light mb-6 max-w-lg mx-auto">
              如果您是媒体工作者，需要采访或获取更多信息，请联系我们的公关团队
            </p>

...
export default function PrivacyPage() {
 ...
 <section>
 <h2 className="text-[15px] font-semibold text-foreground mb-4">1. Information Collection</h2>
 ...
 <section>
 <h2 className="text-[15px] font-semibold text-foreground mb-4">2. Information Usage</h2>
 <p className="text-[13px] text-foreground-light mb-4 leading-relaxed">
 ...
 <section>
 <h2 className="text-[15px] font-semibold text-foreground mb-4">3. Information Sharing</h2>
 <p className="text-[13px] text-foreground-light mb-4 leading-relaxed">
 We will not sell your personal information. We may share information in the following circumstances: 
 </p>
 <ul className="list-disc pl-6 text-[13px] text-foreground-light space-y-2 leading-relaxed">
 ...
 <section>
 <h2 className="text-[15px] font-semibold text-foreground mb-4">4. Public Access and Sharing</h2>
 <p className="text-[13px] text-foreground-light mb-4 leading-relaxed">
 When you choose to make apps and content publicly accessible or share them, related information may be visible to the public or specific audiences.
 </p>
 <ul className="list-disc pl-6 text-[13px] text-foreground-light space-y-2 leading-relaxed">
 <li>Please avoid including sensitive personal information or data in public content</li>
 <li>The visibility of public content depends on your configuration; we do not provide default privacy protection for such content</li>
 <li>You can disable public access or sharing at any time to reduce exposure</li>
 </ul>
 </section>

 <section>
 <h2 className="text-[15px] font-semibold text-foreground mb-4">5. AI-Generated Content and Automated Processing</h2>
 <p className="text-[13px] text-foreground-light mb-4 leading-relaxed">
 To provide AI features, we process the prompts, inputs, and generated results you submit.
 </p>
 <ul className="list-disc pl-6 text-[13px] text-foreground-light space-y-2 leading-relaxed">
 <li>Content may be shared with model service providers for generation and security review</li>
 <li>We follow the principle of minimal data processing for AI-related data and minimize sensitive information</li>
 <li>If you need stricter control over specific data, please consider using private access mode</li>
 </ul>
 </section>
 ...
 We will retain your information for as long as needed to provide our services. After account deletion, we will delete your personal data within 30 days, but may retain anonymized statistical data.
 </p>
 </section>

 <section>
 <h2 className="text-[15px] font-semibold text-foreground mb-4">8. Your Rights</h2>
 <p className="text-[13px] text-foreground-light mb-4 leading-relaxed">You have the right to: </p>
 <ul className="list-disc pl-6 text-[13px] text-foreground-light space-y-2 leading-relaxed">

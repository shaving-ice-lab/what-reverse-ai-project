          ...
          <div className="space-y-8">
            {releases.map((release) => (
              ...
              >
                ...
                {/* Title */}
                <h2 className="text-[15px] font-bold text-foreground mb-2">{release.title}</h2>
                <p className="text-[13px] text-foreground-light mb-4">{release.description}</p>
      ...
      <section className="py-16 px-6 bg-gradient-section">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-[13px] text-foreground-light mb-6">
            Be the first to receive product update notifications
          </p>

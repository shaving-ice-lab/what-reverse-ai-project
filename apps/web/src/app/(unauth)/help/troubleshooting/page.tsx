        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {quickChecks.map((item) => (
              <div
                key={item}
                className={cn('p-4 rounded-2xl', 'bg-surface-100/30 border border-border/30')}
              >
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            ...
            <Link href="/help">
              <Button
                variant="outline"
                className="h-10 px-6 rounded-full text-[13px] border-border/50 hover:bg-surface-200/50"
              >
                Back to Help Center
              </Button>
            </Link>

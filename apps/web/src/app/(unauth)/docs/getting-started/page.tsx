...
const learningPaths = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: "条件分支和循环", href: "/docs/guide/conditional" },
  ...
  },
  {
    id: "developer",
    title: "开发者",
    description: "API 集成和自定义开发",
    duration: "5-8 小时",
    level: "高级",
    steps: [
      { title: "API 文档", href: "/docs/api" },
      { title: "SDK 使用指南", href: "/docs/sdk" },
      { title: "自定义节点开发", href: "/docs/advanced/custom-nodes" },
...
const coreConcepts = [
  ...
  },
  {
    ...
    description: "用于在节点间传递数据并进行动态计算的语法（支持模板与变量）",
  },
];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-foreground-light mb-10 leading-relaxed">
              无论您是初学者还是经验丰富的开发者，这份指南都将帮助您快速掌握 AgentFlow
              并开始构建强大的 AI 工作流
            </p>
      ...
      <section className="py-24 sm:py-32">
        <div className="max-w-6xl mx-auto px-6">
          <div className="lobe-section-header">
            <h2>核心概念</h2>
            <p>了解 AgentFlow 的基本概念，为后续学习打下基础</p>
          </div>

...
const coreConcepts = [
  {
    ...
    title: 'Workflow',
    description:
      'An automation flow composed of multiple nodes that can process data, call services, and execute logic',
  },
  {
    icon: Layers,
    title: 'Node',
  ...
  },
  {
    ...
    title: 'Trigger',
    description:
      'Conditions that start workflow execution, such as scheduled, webhook, or manual triggers',
  },
  {
    icon: Code,
    title: 'Expression',
    description:
      'Syntax for passing data between nodes and performing dynamic calculations (supports templates and variables)',
  },
]
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-foreground-light mb-10 leading-relaxed">
              ...
              quickly master AgentFlow and start building powerful AI workflows
            </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {coreConcepts.map((concept) => (
              ...
              >
                ...
                <h3 className="text-[14px] font-semibold text-foreground mb-2">{concept.title}</h3>
          ...
          <div className="text-center mt-10">
            <Link href="/docs/concepts">
              <Button
                variant="outline"
                className="rounded-full text-[13px] border-border/50 hover:bg-surface-200/50"
              >
                View All Concepts
                <ArrowRight className="ml-2 w-4 h-4" />
              </Button>
              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    {resource.badge && (
                      <span className="lobe-badge text-[11px]">{resource.badge}</span>
                    )}
                  </div>
                  <p className="text-[12px] text-foreground-lighter leading-relaxed">

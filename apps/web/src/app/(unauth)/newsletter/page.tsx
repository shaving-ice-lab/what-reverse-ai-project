        ...
        <div className="pt-32 sm:pt-40 pb-16 px-6">
          <div className="max-w-md mx-auto text-center">
            ...
            <p className="text-[13px] text-foreground-light mb-4">
              Thank you for subscribing! We've already sent a confirmation email to{' '}
              <span className="text-foreground font-medium">{email}</span>.
            </p>
            <p className="text-[12px] text-foreground-lighter mb-8">
              Please check your email (including your spam folder) and click the confirmation link
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 sm:pt-40 pb-12 px-6 bg-gradient-hero">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-[32px] sm:text-[40px] lg:text-[48px] font-semibold text-foreground leading-tight tracking-tight mb-6">
            Stay Up to Date on <span className="text-brand">What&apos;s New</span>
          </h1>
          <p className="text-[15px] text-foreground-light max-w-2xl mx-auto mb-8">
            Subscribe to our newsletter for product updates, technical articles, usage tips, and
            industry insights
          </p>
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-[20px] font-semibold text-foreground mb-4">Past Issues</h2>
            <p className="text-[13px] text-foreground-light">

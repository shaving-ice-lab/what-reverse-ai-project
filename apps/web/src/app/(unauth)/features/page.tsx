...
const coreFeatures = [
 ...
 description: "Smart agents powered by GPT-4, Claude 3, and other large language models that understand complex requirements and automatically execute multi-step tasks.",
 highlights: ["Natural Language Interaction", "Context Understanding", "Autonomous Decision Making"],
 },
 {
 icon: GitBranch,
 ...
 description: "Seamlessly integrate with major SaaS services, databases, and APIs — all your work tools in one place.",
 highlights: ["One-Click Connect", "OAuth Authentication", "Custom Integrations"],
 },
 {
 icon: Layers,
 title: "Template Marketplace",
 description: "Thousands of verified workflow templates covering various industries and scenarios, ready to deploy with one click.",
 highlights: ["Community Contributed", "Quality Verified", "Continuously Updated"],
 },
 {
 icon: Shield,
 title: "Enterprise-Grade Security",
 description: "SOC 2 Type II certified, end-to-end encryption, advanced permission management, and comprehensive audit logs.",
 highlights: ["Data Encryption", "Role-Based Permissions", "Audit Logs"],
 },
 {
 icon: Globe,
 title: "Global Deployment",
 description: "Multi-region data center deployment ensuring low-latency access and 99.99% service availability.",
...
const advancedFeatures = [
 { icon: Repeat, title: "Multi-Agent Collaboration", description: "Multiple AI agents working together to handle complex multi-step tasks" },
 { icon: Terminal, title: "Custom Code Nodes", description: "Create custom logic nodes using JavaScript or Python" },
 { icon: Webhook, title: "Webhook Trigger", description: "Flexible Webhook support for easy integration with external systems" },
 { icon: Database, title: "Data Transformation", description: "Powerful data mapping and transformation capabilities for any data format" },
 { icon: BarChart3, title: "Execution Analytics", description: "Detailed execution logs and performance analytics to optimize workflow efficiency" },
 { icon: Clock, title: "Scheduled Tasks", description: "Flexible Cron expression support for precise control over execution timing" },
 { icon: Users, title: "Team Collaboration", description: "Real-time multi-user collaborative editing with shared workflows and templates" },
 { icon: Lock, title: "Sensitive Data Protection", description: "Encrypted credential storage with support for environment variables and key management" },
];

// AI Capabilities
const aiCapabilities = [
 { title: "Natural Language Processing", description: "Understand and process various language tasks including text analysis, sentiment analysis, and entity extraction", icon: MessageSquare },
 { title: "Smart Decision Making", description: "Automatically make decisions based on context and select the optimal execution path", icon: Sparkles },
 { title: "Code Generation", description: "Automatically generate code snippets to help developers improve efficiency", icon: Code },
 { title: "Data Analytics", description: "Intelligently analyze data and generate insight reports", icon: BarChart3 },
];
...
export default function FeaturesPage() {
 ...
 AgentFlow provides a complete automation solution, from simple task automation to complex enterprise-grade workflows, meeting all your needs.
 </p>
 ...
 Cutting-edge AI capabilities make your workflows smarter and more efficient. Supports multiple large language models including GPT-4, Claude 3, Qwen, and more.
 </p>
 ...
 <p className="text-[14px] text-foreground">&quot;Analyze this sales report and identify key trends&quot;</p>
 </div>
 ...
 Based on the analysis, sales grew 23% this quarter, mainly driven by the new product line. We suggest focusing on regional growth opportunities...
 </p>
 </div>
 </div>
 </div>

...
const rewards = [
  {
    ...
    description:
      "For each successfully referred paid user, you'll earn 20% of their annual subscription amount as a reward",
...
const faqs = [
  {
    ...
    answer:
      "After signing up, get your exclusive referral link from the Settings page. Share it with others — when they sign up and subscribe to a paid plan through your link, you'll earn rewards.",
  },
  {
    question: 'How are rewards distributed?',
    answer:
      'Rewards are distributed to your account balance 30 days after the referred user completes their first payment. You can choose to withdraw them or use them toward subscription costs.',
  },
  {
    question: 'How long is the referral link valid?',
    answer:
      'Referral links are permanently valid. If a referred user signs up and subscribes within 90 days of their first visit, it will count as your referral.',
  },
  {
    question: 'Can I refer companies or teams?',
    answer:
      "Yes! Whether they're individual users or enterprise teams, as long as they subscribe through your referral link, you'll earn the corresponding rewards. Enterprise subscriptions come with higher reward amounts.",
  },
]
      ...
      <section className="pt-32 sm:pt-40 pb-16 px-6 bg-gradient-hero">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-[15px] sm:text-4xl lg:text-5xl font-bold text-foreground tracking-tight mb-6">
            Invite Friends, <span className="text-[#4e8fff]">Earn Rewards</span>
          </h1>

          <p className="text-[13px] text-foreground-light max-w-2xl mx-auto mb-10">
            Share AgentFlow with your friends and colleagues. For each successfully referred paid
            user, you'll earn cash rewards
          </p>
          ...
          <div className="max-w-md mx-auto">
            ...
            <p className="text-[12px] text-foreground-lighter mt-3">
              <Link href="/login" className="text-[#4e8fff] hover:underline">
                Sign in
              </Link>{' '}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-[13px] text-foreground-light">
              3 simple steps to easily earn rewards
            </p>
          </div>
            ...
            {tiers.map((tier, index) => (
              ...
              >
                ...
                <p className="text-[13px] text-foreground-light mb-4">
                  Successfully referred {tier.requirement}
                </p>
            ...
            {[
              {
                ...
                description:
                  'Sign in to your account and get your exclusive referral link from the Settings page',
              },
              {
                step: 2,
                title: 'Share with Friends',
                description: 'Share your link via social media, email, or any other method',
              },
              {
                step: 3,
                title: 'Friends Sign Up & Subscribe',
                description: 'Friends sign up and subscribe to a paid plan through your link',
              },
              {
                step: 4,
                title: 'Earn Rewards',
                description:
                  'Rewards are automatically added to your account — withdraw or use for subscriptions',
              },
            ].map((item) => (
              <div
                key={item.step}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {faqs.map((faq) => (
              <div
                key={faq.question}
                className="p-5 rounded-2xl bg-surface-100/30 border border-border/30"
              >
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="/faq">
              <Button
                variant="outline"
                className="h-12 px-8 rounded-full border-border/50 text-foreground-light"
              >
                Learn More
              </Button>
            </Link>

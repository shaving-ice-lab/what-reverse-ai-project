...
const values = [
  {
    icon: Target,
    title: "使命驱动",
    description: "我们致力于让每个人都能轻松使用 AI 自动化，释放创造力。",
  },
  {
    icon: Heart,
    title: "用户至上",
    description: "用户的成功是我们最大的成就，我们始终倾听用户声音。",
  },
  {
    icon: Sparkles,
    title: "追求卓越",
    description: "在产品、技术和服务上追求极致，不断超越用户期望。",
  },
  {
    icon: Globe,
    title: "开放协作",
    description: "拥抱开源精神，与社区共同成长，共创更好的产品。",
  },
];
...
const team = [
  ...
  },
  {
    name: "李华",
    role: "CTO & 联合创始人",
    bio: "前字节跳动技术专家，AI/ML 领域专家，开源社区活跃贡献者",
    image: null,
    social: { linkedin: "#", twitter: "#" },
  },
  {
...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-20 sm:pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className={cn(
            ...
            AgentFlow 成立于 2023 年，致力于让每个人都能轻松使用 AI 自动化技术，
            释放人类的创造力
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-sm text-muted-foreground font-medium">Our Vision</span>
              </div>
            ...
            <div className="flex items-center justify-center">
              <div className="w-full max-w-sm aspect-square bg-card rounded-3xl border border-border flex items-center justify-center relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent" />
                <Rocket className="w-20 h-20 text-primary/20" />
              </div>
            </div>
          </div>
        </div>
              ...
              {milestones.map((milestone, index) => (
                ...
                >
                  <div className={cn(
                    ...
                    <div className={cn(
                      "inline-block p-4 rounded-xl bg-card border border-border",
                      "hover:border-primary/30 transition-colors"
                    )}>
                  ...
                  {/* Center dot */}
                  <div className="hidden md:flex w-3 h-3 rounded-full bg-primary shrink-0 z-10 shadow-lg shadow-primary/30" />
                ...
                <div className="flex items-center justify-center gap-2">
                  {member.social.linkedin && (
                    <a
                      ...
                      className="w-7 h-7 rounded-lg bg-muted flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/10 transition-all"
                    >
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            {investors.map((investor) => (
              <div
                key={investor.name}
                className={cn(
                  "px-6 py-3 rounded-full bg-card border border-border",
                  "hover:border-primary/30 transition-colors"
                )}
              >
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-sm">Our locations</p>
          </div>

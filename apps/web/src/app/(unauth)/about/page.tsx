...
const values = [
  {
    ...
    description:
      'We empower everyone to easily use AI automation and unleash their creative potential.',
  },
  {
    icon: Heart,
    title: 'User First',
    description: 'User success is our greatest achievement. We always put users first.',
  },
  {
    icon: Sparkles,
    title: 'Relentless Innovation',
    description: 'We constantly exceed user expectations in product, technology, and service.',
  },
  {
    icon: Globe,
    title: 'Open Collaboration',
    description: 'Open source, growing with the community to build better products together.',
  },
]
...
const team = [
  {
    name: 'Zhang Lei',
    role: 'CEO & Co-Founder',
    bio: 'Serial entrepreneur, former VP of Product, 10+ years of enterprise service experience',
    social: { linkedin: '#', twitter: '#' },
  },
  {
    name: 'Li Hua',
    role: 'CTO & Co-Founder',
    bio: 'Former ByteDance tech expert, AI/ML domain specialist, active open source community contributor',
    social: { linkedin: '#', twitter: '#' },
  },
  {
    name: 'Wang Fang',
    role: 'CPO',
    bio: 'Former Tencent product director, focused on enterprise-grade product design, UX expert',
    social: { linkedin: '#' },
  },
  {
    name: 'Chen Wei',
    role: 'VP of Engineering',
    bio: 'Former Meituan tech lead, distributed systems expert, technology architect',
    social: { linkedin: '#' },
  },
]
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 sm:pt-40 pb-20 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          >
            Founded in 2023, AgentFlow empowers everyone to easily use AI automation technology and
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {stats.map((stat) => (
              ...
              >
                <div className="text-3xl sm:text-4xl font-bold text-foreground tracking-tight mb-1">
                  {stat.value}
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-foreground-light mb-4 leading-relaxed">
                We believe everyone will have their own AI assistant to help handle daily repetitive
                tasks. AgentFlow is dedicated to building the most user-friendly AI workflow
                platform.
              </p>
              <p className="text-foreground-light leading-relaxed">
                With our visual workflow editor and smart AI agents, we help users quickly build
                automated workflows. No programming needed — anyone can implement complex business
                automation.
              </p>
            </div>
                ...
                >
                  <div className={cn('flex-1', index % 2 === 0 ? 'md:text-right' : 'md:text-left')}>
                    <div className="inline-block p-4 rounded-xl bg-surface-100/30 border border-border/30 hover:border-border/60 transition-colors">
                      <div className="text-[11px] text-brand-500 font-medium mb-1 uppercase tracking-widest">
                        {milestone.year}
                      </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {team.map((member) => (
              ...
              >
                ...
                <p className="text-[11px] text-foreground-lighter mb-4 leading-relaxed">
                  {member.bio}
                </p>
                <div className="flex items-center justify-center gap-2">
                  {member.social.linkedin && (
                    <a
                      ...
                      className="w-7 h-7 rounded-lg bg-surface-200/50 flex items-center justify-center text-foreground-muted hover:text-foreground-light transition-all"
                    >
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            {investors.map((investor) => (
              <div
                key={investor.name}
                className="px-6 py-3 rounded-full bg-surface-100/30 border border-border/30"
              >
                <span className="text-foreground-lighter text-[14px] font-medium">
                  {investor.name}
                </span>
              </div>
            ))}
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={office.city}
                className="p-5 rounded-2xl bg-surface-100/30 border border-border/30 hover:border-border/60 transition-colors"
              >
      ...
      <section className="relative py-24 sm:py-32 overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-foreground-light mb-10">
            We&apos;re looking for the best talent to shape the future of automation together
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <Link href="/contact">
              <Button
                variant="outline"
                className="h-12 px-8 rounded-full border-border/50 hover:bg-surface-200/50"
              >
                Contact Us
              </Button>
            </Link>

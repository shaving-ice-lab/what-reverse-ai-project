...
const securityFeatures = [
  {
    ...
    description:
      'All data transfers use TLS 1.3 encryption; sensitive data is stored with AES-256 encryption',
  ...
  },
  {
    ...
    description:
      'Enterprise-grade infrastructure with multi-region deployment and 99.99% availability guarantee',
  ...
  },
  {
    ...
    description:
      'Fine-grained permission management with SSO and multi-factor authentication support',
      ...
      <section className="relative pt-32 sm:pt-40 pb-20 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 px-6">
          ...
          <p className="text-lg text-foreground-light max-w-2xl mx-auto mb-10 leading-relaxed">
            We use industry-leading security measures and compliance standards to ensure your data
            receives the most advanced protection
          </p>
      ...
      <section className="relative py-24 sm:py-32 overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-foreground-light mb-10">
            We value the contributions of security researchers and welcome responsible disclosure of

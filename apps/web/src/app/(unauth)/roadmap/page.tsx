...
import { Rocket, CheckCircle, Clock, Lightbulb, ArrowRight } from 'lucide-react'
...
const roadmapItems = [
  {
    ...
    items: [
      {
        title: 'AI Agent 2.0',
        description: 'All-new AI engine with multi-model collaboration support',
        done: true,
      },
      {
        title: 'Visual Editor Upgrade',
        description: 'Smoother drag-and-drop experience',
        done: true,
      },
      {
        title: 'Enterprise-Grade SSO',
        description: 'Support for SAML and OIDC authentication',
        done: true,
      },
    ],
  },
  {
    ...
    items: [
      { title: 'Mobile App', description: 'Native iOS and Android apps', done: false },
      {
        ...
        description: 'In-depth usage data analytics',
        done: false,
      },
      {
        title: 'More Integrations',
        description: 'Adding 50+ third-party service integrations',
        done: false,
      },
    ],
  },
    ...
    items: [
      {
        ...
        description: 'Automatically generate workflows from natural language descriptions',
        done: false,
      },
      {
      ...
      {
        title: 'Template Marketplace 2.0',
        description: 'Richer template categories and improved search',
        done: false,
      },
    ],
  },
  {
    ...
    items: [
      {
        title: 'Enhanced Private Deployment',
        description: 'Simplified deployment process',
        done: false,
      },
      {
        title: 'Multi-Language Support',
        description: 'Support for more languages in the interface',
        done: false,
      },
      {
        title: 'Advanced Automation',
        description: 'More complex conditional and loop logic',
        done: false,
      },
    ],
  },
      ...
      <section className="pt-32 sm:pt-40 pb-16 px-6 bg-gradient-hero">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-[13px] text-foreground-light max-w-2xl mx-auto">
            Features we're currently building, along with our future plans. Your feedback helps us
            prioritize.
          </p>
        </div>
      </section>
              ...
              return (
                <div key={quarter.quarter} className="relative">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    <h2 className="text-[15px] font-bold text-foreground">{quarter.quarter}</h2>
                    <span
                      className={cn(

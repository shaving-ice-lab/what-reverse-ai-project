      ...
      <section className="relative pt-32 sm:pt-40 pb-20 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10 px-6">
          ...
          <p className="text-lg text-foreground-light max-w-2xl mx-auto leading-relaxed">
            From ticket submission to follow-up, we provide every user with a clear, trackable
            support path.
          </p>
        </div>
      </section>
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-[13px] text-foreground-lighter mt-1">
                  Fill in key information; the system will automatically assign priority and
            ...
            {ticket ? (
              <div className="rounded-2xl border border-brand-500/30 bg-brand-500/5 p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-[13px] text-foreground-lighter">
                      Reference number:{' '}
                      <span className="text-foreground font-medium">{ticket.reference}</span>
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-3 mt-6">
                  ...
                  <Link href="/help">
                    <Button className="rounded-full bg-foreground hover:bg-foreground/90 text-background">
                      Continue
                    </Button>
                  </Link>
                </div>
            ...
            <div className="rounded-2xl border border-border/30 bg-surface-100/30 p-6">
              ...
              <div className="space-y-4">
                {activeSLA.targets.map((target) => (
                  <div
                    key={target.priority}
                    className="rounded-xl border border-border/30 bg-surface-200/30 p-4"
                  >
                    <div className="flex items-center justify-between text-[13px]">
                      <span className="font-medium text-foreground">
                        {supportPriorities.find((item) => item.id === target.priority)?.label ||
                          target.priority}
                      </span>

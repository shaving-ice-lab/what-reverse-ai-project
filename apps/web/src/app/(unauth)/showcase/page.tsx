...
import { Search, Star, Eye, ArrowRight, Sparkles } from 'lucide-react'
...
const showcaseItems = [
  {
    ...
    description:
      '24/7 automated customer response with multi-channel support, improving processing efficiency by 300%',
  ...
  },
  {
    ...
    description:
      'Automatically review pull requests, check code quality and standards, reducing manual review time',
    author: 'DevOps Team',
  ...
  },
  {
    ...
    description:
      'Automatically publish content across multiple social media platforms with scheduled posting and data analytics',
  ...
  },
  {
    ...
    description:
      'Automatically aggregate financial data, generate standardized reports, and integrate seamlessly with ERP systems',
  ...
  },
  {
    ...
    description:
      'Automatically categorize and assign bugs to the right developers, improving issue resolution efficiency',
  ...
  },
  {
    ...
    description:
      'Automatically evaluate sales leads, prioritize high-value customers, and improve conversion rates',
    author: 'Sales Team',
    category: 'Sales',
    views: 4800,
    stars: 176,
      ...
      <section className="pt-32 sm:pt-40 pb-16 px-6 bg-gradient-hero">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-[13px] text-foreground-light max-w-2xl mx-auto mb-8">
            Explore outstanding workflows created by community members for inspiration and best
            practices
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredItems.map((item) => (
              ...
              >
                ...
                <div className="text-[11px] text-foreground-lighter mb-4">by {item.author}</div>
      ...
      <section className="py-16 px-6 bg-gradient-section">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-[13px] text-foreground-light mb-6">
            Share your creations with the community and help more people improve their productivity
          </p>

...
const testimonials = [
  {
    quote:
      'AgentFlow cut our support response time from 30 min to 2 min; customer satisfaction improved 45%.',
    author: 'Sarah L.',
  ...
  {
    quote:
      'Appointment scheduling and workflow automation significantly improved patient satisfaction.',
    author: 'Dr. Emily R.',
    role: 'IT Director',

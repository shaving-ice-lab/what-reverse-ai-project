          ...
          <div className="grid md:grid-cols-3 gap-4">
            {contactMethods.map((method) => (
              ...
              >
                ...
                <h3 className="text-[14px] font-semibold text-foreground mb-1">{method.title}</h3>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              {/* Offices */}
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-4">Office Locations</h3>
                <div className="space-y-4">
                  {offices.map((office) => (
                    ...
                    >
                      ...
                      <p className="text-[12px] text-foreground-lighter pl-9">{office.address}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              {/* Response Time */}
              <div className="p-4 rounded-xl bg-surface-100/30 border border-border/30">
                <h4 className="font-medium text-foreground mb-2 text-[14px]">Response Time</h4>

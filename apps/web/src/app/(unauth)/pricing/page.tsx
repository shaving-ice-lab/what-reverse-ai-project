...
import { Check, X, Sparkles, ArrowRight, Plus } from 'lucide-react'
...
const faqs = [
  {
    ...
    answer:
      'Yes! Both the Professional and Team plans offer a 14-day free trial with no credit card required.',
  },
  {
    question: 'How do I upgrade or downgrade my plan?',
    answer:
      'You can upgrade or downgrade your plan at any time in your Account Settings. Upgrades take effect immediately, while downgrades take effect at the end of the current billing cycle.',
  },
  {
    question: 'What payment methods are supported?',
    answer:
      'We support credit cards, Alipay, WeChat Pay, and bank transfers for enterprise customers.',
  },
  {
    question: 'Are there education or nonprofit discounts?',
    answer:
      'Yes! We offer a 50% discount for educational institutions and a 30% discount for nonprofits. Please contact us for details.',
  },
]
      ...
      <section className="relative pt-32 sm:pt-40 pb-16 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-lg text-foreground-light max-w-2xl mx-auto mb-10 leading-relaxed">
            Start with the free plan and upgrade anytime. All paid plans include a 14-day free
            trial.
          </p>
                ...
                <ul className="space-y-2.5">
                  {plan.features.map((feature) => (
                    <li key={feature.name} className="flex items-center gap-2.5 text-[13px]">
                      ...
                      <span
                        className={
                          feature.included ? 'text-foreground-light' : 'text-foreground-muted'
                        }
                      >
                        {feature.name}
                      </span>

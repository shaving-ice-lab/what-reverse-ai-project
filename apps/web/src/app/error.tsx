    ...
    <div className="min-h-screen bg-background flex flex-col overflow-hidden">
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-16">
        <div className="max-w-md mx-auto text-center">
          ...
          >
            Sorry, something went wrong. We've logged the issue. Please try refreshing the page or
            try again later.
          </p>
          ...
          >
            <p className="text-sm text-muted-foreground mb-6">or access the following pages</p>
          ...
          >
            <div className="flex items-start gap-4 text-left">
              ...
              <div>
                <h3 className="font-semibold text-foreground mb-1 text-sm">Issue not resolved?</h3>

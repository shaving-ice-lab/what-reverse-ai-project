            ...
            <div className="page-panel-header flex items-center justify-between gap-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="page-panel-description">
                    Select the data and format you want to export
                  </p>
                </div>
              </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center justify-between pt-4 border-t border-border">
                <p className="text-[13px] text-foreground-light">
                  Estimated size:{' '}
                  <span className="font-medium text-foreground">{totalSize.toFixed(1)} MB</span>
                </p>
                <Button
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-start gap-2 p-3 rounded-md border border-warning/30 bg-warning-200/60">
                ...
                <p className="text-xs text-foreground-light">
                  Import may modify existing settings. We recommend exporting your current data as a
          ...
          <div className="p-6 flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-[13px] text-foreground-light mb-4">
                All exported data is encrypted. Export files are automatically deleted after 7 days.
                Please download them promptly.
              </p>

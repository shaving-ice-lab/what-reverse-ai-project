      ...
      return (
        <div className="rounded-2xl border border-border bg-surface-100 p-8 text-center">
          ...
          <p className="mt-2 text-sm text-foreground-muted">
            This account is not authorized to access admin management. Please contact a system
            administrator.
          </p>
        </div>
      )
                          ...
                          <Button
                            ...
                            onClick={() =>
                              openActionDialog({
                                ...
                                description:
                                  'Workspace resources will not be accessible after suspension.',
                                nextStatus: 'suspended',
                              })
                            }
                          >
                          ...
                          <Button
                            ...
                            onClick={() =>
                              openActionDialog({
                                ...
                                description:
                                  'Resources will be accessible again after restoration.',
                                nextStatus: 'active',
                              })
                            }
                          >
      ...
      >
        <div className="space-y-2">
          ...
          <textarea
            ...
            placeholder={
              actionTarget?.type === 'ticket'
                ? 'Add a status note (optional)'

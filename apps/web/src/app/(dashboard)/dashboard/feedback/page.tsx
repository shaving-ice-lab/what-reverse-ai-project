...
const myFeedback = [
  {
    ...
    reply:
      'Thank you for your suggestion! We are currently developing more detailed execution log features. Expected in the next release.',
  },
  {
    id: 'f2',
    ...
    createdAt: '2026-01-20',
    reply:
      'The issue has been fixed. We optimized service response time and added a timeout retry mechanism.',
  },
]
...
export default function FeedbackPage() {
  ...
  const filtersActive = typeFilter !== 'all' || statusFilter !== 'all' || normalizedQuery.length > 0
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-description">
            Submit suggestions, report issues, and track processing progress
          </p>
        ...
        <div className="p-6">
          <div className="page-grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="rounded-md border border-border bg-surface-75/60 p-4 transition-supabase hover:border-border-strong">
              ...
              <div className="mt-2 text-stat-number text-foreground">
        ...
        <div className="space-y-6">
          <div className="page-panel">
            <div className="page-panel-header">
              <div className="flex items-center justify-between">
                ...
                <Badge
                  variant="secondary"
                  className="bg-surface-200 text-foreground-muted text-[10px] tracking-wider"
                >
                  Priority Evaluation
                </Badge>
              </div>
              <p className="page-panel-description">
                Clear descriptions help enter the processing queue faster
              </p>
            </div>
                    ...
                    <div className="flex items-center justify-between gap-3">
                      <div>
                        ...
                        <div className="text-xs text-foreground-muted mt-1">
                          Supports PNG, JPG, and log files
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                        <Button
                ...
                <div className="space-y-4">
                  <div className="rounded-md border border-border bg-surface-75/60 p-4">
                    ...
                    <p className="text-xs text-foreground-muted mt-2">
                      Select a feedback type to get started quickly. A clear description helps us
                      process it faster.
                    </p>
                  </div>
          ...
          <div className="page-panel">
            <div className="page-panel-header">
              ...
              <p className="page-panel-description">
                Tips to make your suggestions more actionable for the team
              </p>
            </div>
            <div className="p-5 space-y-3 text-[13px] text-foreground-light">
              <div className="flex items-start gap-2">
                ...
                <div>
                  Describe the background and goal so we understand the scenario where the issue
                  occurs.
                </div>
              </div>
              <div className="flex items-start gap-2">
              ...
              <div className="flex items-start gap-2">
                ...
                <div>Use votes and comments wisely to help feedback get noticed more easily.</div>
              </div>
            </div>
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    <Badge variant="secondary" className={cn(status.bg, status.color)}>
                      <StatusIcon
                        className={cn('w-3 h-3 mr-1', key === 'in_progress' && 'animate-spin')}
                      />
                      {status.label}
                    </Badge>
                  </div>
          ...
          <div className="page-panel">
            <div className="page-panel-header">
              ...
              <p className="page-panel-description">
                For blocking issues, please contact our support team
              </p>
            </div>
          ...
          <div className="page-panel-header">
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="page-panel-description">
                  Community suggestions and your feedback progress
                </p>
              </div>
            ...
            <TabsContent value="popular" className="mt-0 space-y-3">
              {filteredSuggestions.length === 0 ? (
                ...
                filteredSuggestions.map((item) => {
                  ...
                  const status =
                    statusConfig[item.status as keyof typeof statusConfig] || statusConfig.open
              ...
              {filteredMine.length === 0 ? (
                <div className="flex flex-col items-center justify-center rounded-md border border-border bg-surface-75/60 py-16">
                  ...
                  <p className="text-xs text-foreground-light mb-4">
                    Share your suggestions to help us improve our product
                  </p>
                  <Button
                    onClick={() => setShowForm(true)}
                    size="sm"

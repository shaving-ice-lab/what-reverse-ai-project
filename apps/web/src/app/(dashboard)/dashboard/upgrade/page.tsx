...
const faqs = [
 {
  ...
  answer: "Yes, you can upgrade or downgrade your plan anytime. Upgrades take effect immediately. Downgrades take effect at the end of the current billing cycle.",
 },
 {
  question: "What happens after exceeding my quota?",
  answer: "After exceeding quota, service won't stop immediately. We'll notify you and give you time to upgrade or wait until the next quota reset.",
 },
 {
  question: "Which payment methods are supported?",
  answer: "We support Visa, Mastercard, PayPal, and WeChat Pay. Enterprise plans also support invoicing and annual contracts.",
 },
 {
  question: "Is there a refund policy?",
  answer: "14-day no-questions-asked refund. If you're not satisfied, request a full refund within 14 days of purchase.",
 },
];
 ...
 return (
  <PageContainer className="space-y-8">
   ...
   <div className="page-grid md:grid-cols-3">
	...
	Current plan
       ...
       <CardFooter bordered align="between">
        ...
        >
         {plan.current ? "Current plan" : plan.id === "free" ? "Downgrade to free" : "Upgrade now"}
        </Button>
       </CardFooter>
      </Card>
     );
   ...
   <div className="page-grid md:grid-cols-3 text-center">
	...
	<p className="text-[12px] text-foreground-light">Support for multiple payment methods</p>
     </div>
    </Card>
   </div>
  </PageContainer>

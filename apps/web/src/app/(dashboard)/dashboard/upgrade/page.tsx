 ...
 * CoverageBillingweeks, Planforcompare, EnterprisePlanand FAQ
 */
...
const plans = [
 ...
 id: "free",
 name: "Freeversion",
 description: "SuitablepersonTryandLearn",
 price: 0,
 priceYearly: 0,
 features: [
 { name: "1,000 times API Call/months", included: true },
 { name: "5 Workflow", included: true },
 { name: "3 AI Agent", included: true },
 { name: "1 GB StorageEmptybetween", included: true },
 { name: "BasicModelAccess", included: true },
 { name: "CommunitySupport", included: true },
 { name: "AdvancedModelAccess", included: false },
 { name: "PrioritySupportSupport", included: false },
 ...
 priceYearly: 79,
 features: [
 { name: "50,000 times API Call/months", included: true },
 { name: "NonelimitWorkflow", included: true },
 { name: "Nonelimit AI Agent", included: true },
 { name: "20 GB StorageEmptybetween", included: true },
 { name: "GPT-4, Claude etcAdvancedModel", included: true },
 { name: "PrioritySupportSupport", included: true },
 { name: "5 personTeamCollaboration", included: true },
 { name: "API CompleteAccess", included: true },
 { name: "CustomBrand", included: false },
 { name: "ExclusiveCustomerManager", included: false },
 ],
 popular: true,
 current: false,
 },
 ...
 id: "team",
 name: "Teamversion",
 description: "SuitablelargeTeam",
 price: 299,
 priceYearly: 249,
 features: [
 { name: "200,000 times API Call/months", included: true },
 { name: "NonelimitWorkflow", included: true },
 { name: "Nonelimit AI Agent", included: true },
 { name: "100 GB StorageEmptybetween", included: true },
 { name: "AllAdvancedModel", included: true },
 { name: "24/7 ExclusiveSupport", included: true },
 { name: "NonelimitTeamMember", included: true },
 { name: "Advanced API Features", included: true },
 { name: "CustomBrand", included: true },
 { name: "ExclusiveCustomerManager", included: true },
 ],
 popular: false,
 current: false,
 },
...
const enterpriseFeatures = [
 ...
 "CustomModelTraining",
 "SLA Assurance",
 "ExclusiveTechnologySupport",
 "CustomizeFeaturesDevelopment",
];

// FAQ
const faqs = [
 {
 question: "canwithAnytimeUpgradeorDowngrade??",
 answer: "is's, youcanwithAnytimeUpgradePlan, UpgradeafterNowTake Effect.DowngradewillatCurrentBillingweeksEndafterTake Effect.",
 },
 {
 question: "ExceedQuotaafterwillstyle?",
 answer: "ExceedQuotaafter, ServicenotwillNowStop.WewillNotificationsyouandProvidetimeQuota, youcanwithSelectUpgradePlanoretcpendingdownmonthsQuotaReset.",
 },
 {
 question: "SupportWhichPaymentmethod?",
 answer: "WeSupportuse, , Payment, WeChatPayment.EnterprisestillSupportforandyears.",
 },
 {
 question: "hasRefundPolicy??",
 answer: "Provide 14 daysNoneReasonRefundGuarantee.ifresultyouforServicenotSatisfied, canwithatPurchaseafter 14 daysinPleaseallRefund.",
 },
];
...
export default function UpgradePage() {
 ...
 <PageHeader
 eyebrow="Billing"
 title="SelectSuitableyou'sPlan"
 description="1'sBillingandPermissionManage, byneedUpgradeandSupportAnytimeSwitch."
 icon={<Crown className="w-4 h-4" />}
 actions={
 <div className="flex flex-col items-start gap-2 sm:flex-row sm:items-center">
 <div
 role="tablist"
 aria-label="Billingweeks"
 ...
 yearscanAnytimeSwitch, AutoRenewbeforeReminder
 </div>
 </div>
 }
 />
 ...
 <div className="text-[12px] text-foreground-light">CurrentBillingweeks</div>
 <div className="text-sm font-medium text-foreground">
 {isYearly ? "yearsPlan(Save 20%)": "monthsPlan"}
 </div>
 <p className="text-[11px] text-foreground-muted">
 downtimesday: 2026-03-01 · canAnytimeChange
 </p>
 </div>
 ...
 <div className="text-[11px] text-foreground-muted">
 {plan.price > 0 ? "/ months": "PermanentFree"}
 </div>
 </div>
 </div>
 </CardHeader>
 ...
 yearsSum ¥{plan.priceYearly * 12}, Save ¥{yearlySavings}
 </div>
 )}
 ...
 {plan.price === 0 ? "Noneneeduse": "SupportAnytimeCancel"}
 </span>
 <Button
 size="sm"
 ...
 >
 {plan.current ? "CurrentPlan": plan.id === "free" ? "DowngradetoFreeversion": "NowUpgrade"}
 </Button>
 </CardFooter>
 </Card>
 );
 ...
 aslargeTeamandComplianceScenarioProvideExclusivePlan
 </p>
 </div>
 </div>
 ...
 <div className="text-[12px] font-medium text-foreground">limittimeDiscount</div>
 <p className="text-[12px] text-foreground-light">
 UsageDiscount{""}
 <code className="px-2 py-0.5 rounded-md bg-warning/20 text-warning font-mono">
 NEWYEAR2026
 </code>{""}
 yearsoutside 9 Discount
 </p>
 </div>
 ...
 <h3 className="text-sm font-medium text-foreground mb-1">SecurityPayment</h3>
 <p className="text-[12px] text-foreground-light">256 SSL EncryptProtect</p>
 </div>
 </Card>
 <Card variant="default" padding="sm">
 <div className="p-1">
 <Clock className="w-6 h-6 text-brand-500 mx-auto mb-3" />
 <h3 className="text-sm font-medium text-foreground mb-1">14 daysRefund</h3>
 <p className="text-[12px] text-foreground-light">NoneReasonallRefundGuarantee</p>
 </div>
 </Card>
 <Card variant="default" padding="sm">
 <div className="p-1">
 <CreditCard className="w-6 h-6 text-brand-500 mx-auto mb-3" />
 <h3 className="text-sm font-medium text-foreground mb-1">FlexiblePayment</h3>
 <p className="text-[12px] text-foreground-light">SupportmultipletypePaymentmethod</p>
 </div>
 </Card>
 </div>
 </PageContainer>

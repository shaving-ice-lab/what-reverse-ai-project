...
export default function ModelsPage() {
  ...
  const topQualityModel = models.reduce(
    (best, model) => (model.quality > best.quality ? model : best),
    models[0]
  )
  ...
  const mostPopularModel = models.reduce(
    (best, model) => (model.popularity > best.popularity ? model : best),
    models[0]
  )
              ...
              <div className="page-panel-header flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <p className="page-panel-description">
                    Currently showing {filteredModels.length} models. Select and configure as
                    needed.
                  </p>
                </div>
                        ...
                        >
                          ...
                          <div className="mt-4 grid gap-3 border-t border-border pt-4 md:grid-cols-2">
                            ...
                            <div className="space-y-2">
                              <div className="flex items-center justify-between text-xs">
                                ...
                                <span className={cn('font-medium', speed.color)}>
                                  {speed.label}
                                </span>
                              </div>
                              <Progress
                                value={speed.value}
                                size="sm"
                                variant={speed.value >= 75 ? 'success' : 'default'}
                              />
                            </div>
                          </div>
                          ...
                          <div className="mt-4 flex flex-wrap items-center justify-between gap-3 border-t border-border pt-4 text-[12px] text-foreground-light">
                            <div className="flex flex-wrap items-center gap-4">
                              ...
                              <span>
                                Input{' '}
                                <span className="text-foreground">${model.inputPrice}/1K</span>
                              </span>
                              <span>
                                Output{' '}
                                <span className="text-foreground">${model.outputPrice}/1K</span>
                              </span>
                            </div>
                            {!compareMode && (
                              <div className="flex items-center gap-2">
            ...
            <div className="page-panel">
              <div className="page-panel-header">
                <div>
                  ...
                  <p className="page-panel-description">
                    Select models based on quality, speed, and popularity.
                  </p>
                </div>
              </div>
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-foreground-light">
                      {fastestModel.name} ({fastestSpeedLabel}) suitable for real-time interactive
                      scenarios.
                    </p>
                  </div>
                </div>

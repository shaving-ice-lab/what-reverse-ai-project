    ...
    >
      <PageContainer>
        ...
        <section id="status" className="scroll-mt-6 mt-6">
          <SettingsSection title="Status" description="System run status and resource monitoring">
        ...
        <section id="actions" className="scroll-mt-6 mt-6">
          <SettingsSection title="Quick Actions" description="Frequently used feature shortcuts">
        ...
        <section id="usage" className="scroll-mt-6 mt-6">
          <SettingsSection title="Resource Usage" description="Token and API call statistics">
            <div className="space-y-4">
              {/* Token Usage */}
...
function MetricItem({ label, value, subtext, trend, isLoading }: MetricItemProps) {
  ...
  return (
    <div className="p-4 rounded-md border border-border bg-surface-75 hover:border-border-strong transition-colors">
      <div className="text-[11px] text-foreground-muted uppercase tracking-wide mb-1">{label}</div>
    ...
    >
      ...
      <span
        className={cn(
          ...
          statusColors[workflow.status] || 'text-foreground-muted'
        )}
      >
...
function UsageBar({ label, used, limit, unit = '' }: UsageBarProps) {
  ...
  return (
    <div>
      ...
      <div className="text-[10px] text-foreground-muted mt-1">{percent.toFixed(1)}% used</div>
    </div>
  )
}

      ...
      <div className="space-y-6">
        ...
        <div className="page-grid sm:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="page-panel p-4">
            ...
            <p className="mt-2 text-stat-number text-foreground tabular-nums">{successRate}%</p>
            ...
            <div className="page-panel-header flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="page-panel-description">
                  Quickly find records by keywords, type, and time range
                </p>
              </div>
            ...
            {groupedActivities.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="text-[13px] text-foreground-light">
                  {searchQuery
                    ? 'Try different search keywords or adjust filter criteria'
                    : 'Your activity will be displayed here'}
                </p>
              </div>
            ) : (
              <>

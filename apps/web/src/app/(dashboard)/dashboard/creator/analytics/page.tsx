        ...
        <div className="space-y-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            {overviewStats.map((stat) => (
              <div key={stat.label} className="page-panel p-6">
                ...
                <div className="text-[13px] text-foreground-light">{stat.label}</div>

                <div className="text-xs text-foreground-muted mt-2">{stat.description}</div>
              </div>
            ))}
          </div>
              ...
              <div className="space-y-3">
                {dailyData.map((data) => (
                  <div key={data.date} className="flex items-center gap-4">
                    <span className="text-xs text-foreground-muted w-12">{data.date}</span>
                ...
                {topWorks.map((work, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-foreground-muted">{work.type}</div>
                    </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-foreground-light">
                      Your template usage increased this week. Publish new work to get more
                      exposure.
                    </p>
                  </div>
                </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                <div key={insight.title} className="p-4 rounded-md bg-surface-75">
                  ...
                  <div className="text-xs text-foreground-muted">{insight.description}</div>
                </div>
              ))}
            </div>
          </div>

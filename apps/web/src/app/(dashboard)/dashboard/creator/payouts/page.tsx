                ...
                return (
                  ...
                  >
                    <div className="w-10 h-10 rounded-md bg-surface-200 flex items-center justify-center">
                      {accountType && (
                        <accountType.icon className="w-5 h-5 text-foreground-muted" />
                      )}
                    </div>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {account.verified && <CheckCircle className="w-4 h-4 text-brand-500" />}
                      </div>
                ...
                <tbody className="divide-y divide-border">
                  {payoutHistory.map((payout) => (
                    <tr key={payout.id} className="bg-surface-100">
                      ...
                      <td className="px-4 py-3 text-xs text-foreground-muted">{payout.account}</td>
          ...
          <div className="page-panel p-6">
            ...
            <div className="page-grid sm:grid-cols-2">
              {payoutRules.map((rule) => (
                <div
                  key={rule.label}
                  className="flex items-center justify-between p-3 rounded-md bg-surface-75"
                >
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-foreground-light">
                    To protect your security, please confirm your account info before withdrawing.

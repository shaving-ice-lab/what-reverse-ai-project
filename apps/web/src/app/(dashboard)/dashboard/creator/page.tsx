...
const mockDashboard = {
  account: {
    ...
    total_earned: 15680.5,

    total_withdrawn: 12420.0,

    monthly_revenue: 3260.5,
  ...
  today_earnings: 128.5,

  week_earnings: 856.0,

  month_earnings: 3260.5,

  by_type: [
    { type: 'sale', count: 45, amount: 2280.5 },

    { type: 'subscription', count: 18, amount: 680.0 },

    { type: 'tip', count: 12, amount: 200.0 },

    { type: 'referral', count: 3, amount: 100.0 },
  ],
  ...
  monthly: [
    ...
    { month: '2026-01', gross: 3260.5, net: 2445.38, count: 45 },
  ],
  ...
  top_agents: [
    { agent_id: '1', agent_name: 'AI CopyAssistant', count: 68, amount: 5200.0 },

    { agent_id: '2', agent_name: 'DataAnalytics', count: 45, amount: 3800.0 },

    { agent_id: '3', agent_name: 'SupportBot', count: 32, amount: 2600.0 },

    { agent_id: '4', agent_name: 'CodeReviewAssistant', count: 18, amount: 1500.0 },
  ],
}
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <Card className="bg-surface-100 border-border">
              <CardHeader>
                ...
                <CardDescription className="text-[13px]">
                  This month&apos;s earnings breakdown by type
                </CardDescription>
              </CardHeader>
            ...
            <Card className="bg-surface-100 border-border">
              ...
              <CardFooter className="border-t border-border bg-surface-75/70">
                <Link
                  ...
                  className="text-[13px] text-brand-500 hover:underline flex items-center"
                >
                  View All Agents
            ...
            <Card className="bg-surface-100 border-border">
              ...
              <CardContent className="space-y-4">
                {dashboard.recent_earnings.slice(0, 5).map((earning) => {
                  const typeConfig =
                    earningTypeConfig[earning.earning_type as keyof typeof earningTypeConfig]
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 text-xs text-foreground-muted">
                          ...
                          <Badge
                            variant="secondary"
                            size="sm"
                            className={cn('text-[11px]', statusCfg.bgColor, statusCfg.color)}
                          >
                            {statusCfg.label}
                          </Badge>
                        </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Tabs defaultValue="all" className="w-auto">
                  <TabsList
                    variant="segment"
                    size="sm"
                    className="bg-surface-200 border border-border"
                  >

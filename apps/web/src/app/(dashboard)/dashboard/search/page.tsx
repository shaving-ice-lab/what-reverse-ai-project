...
/**
 * Global Search Result Page - Supabase Style
 * Search Workflow, Agent, Conversation, File, etc.
 */
...
const mockResults = {
 ...
 id: "wf-2",
 type: "workflow",
 title: "Email Auto-Categorization",
 description: "Automatically categorize inbox emails based on content",
 status: "active",
 lastRun: "5h ago",
 runs: 892,
 starred: false,
 ...
 description: "Help you write documents and content",
 model: "GPT-4",
 conversations: 156,
 starred: true,
 },
 ...
 description: "Automatically review code and provide optimization suggestions",
 model: "Claude 3",
 conversations: 89,
 starred: false,
 },
 ...
 preview: "About new feature requirements analysis and priority sorting...",
 model: "GPT-4",
 messages: 24,
 updatedAt: "1h ago",
 },
 ...
 preview: "Discussion on system architecture design and technology selection...",
 model: "Claude 3",
 messages: 18,
 updatedAt: "3h ago",
 },
 ...
 id: "fl-1",
 type: "file",
 title: "Product Requirements Document v2.0.docx",
 fileType: "document",
 size: "2.4 MB",
 ...
 id: "fl-2",
 type: "file",
 title: "API Interface Standard.md",
 fileType: "document",
 size: "156 KB",
 ...
 id: "tp-1",
 type: "template",
 title: "Support Auto-Reply Template",
 description: "Automated support reply workflow template",
 ...
 id: "tp-2",
 type: "template",
 title: "Data Analytics Report Generator",
 description: "Automatically generate data analytics reports",
...
export default function SearchPage() {
 ...
 <Input
 type="text"
 placeholder="Search workflows, agents, conversations, files..."
 value={query}
 ...
 <span className="page-panel-title">Recent Searches</span>
 </div>
 ...
 <span className="page-panel-title">Popular Searches</span>
 </div>
 <div className="p-4 flex flex-wrap gap-2">
 ...
 <span className="page-panel-title">Quick Shortcuts</span>
 </div>
 ...
 <h4 className="text-sm font-medium text-foreground group-hover:text-brand-500 transition-colors">Create Workflow</h4>
 <p className="text-[13px] text-foreground-light mt-1">Automate your tasks</p>
 </Link>
 ...
 <p className="text-[13px] text-foreground-light mt-1">Customize your AI assistant</p>
 </Link>
 ...
 <h4 className="text-sm font-medium text-foreground group-hover:text-brand-500 transition-colors">Start Conversation</h4>
 <p className="text-[13px] text-foreground-light mt-1">Chat with AI</p>
 </Link>
 </div>
 </div>
 </div>
 ...
 <div>
 <h3 className="page-panel-title">Search Results</h3>
 <p className="page-panel-description">
 Found {filteredResults.length} results related to "{query || initialQuery}"
 </p>
 </div>
 </div>
 ...
 <p className="text-[13px] text-foreground-light">Try different search keywords</p>
 </div>
 ) : (
 <div className="space-y-3">
 ...
 {result.messages && (
 <span>{result.messages} Messages</span>
 )}
 {result.size && (
 <span>{result.size}</span>
 )}
 {result.uses && (
 <span>{result.uses} uses</span>
 )}

...
// RecentSearch
const recentSearches = ['Customer Feedback', 'GPT-4', 'API Document']
            ...
            <div className="page-panel">
              ...
              <div className="p-4 page-grid md:grid-cols-3">
                <Link
                  ...
                  className="p-4 rounded-md bg-surface-100 border border-border-muted hover:border-border-strong transition-supabase group"
                >
                  <Zap className="w-6 h-6 text-warning mb-3" />
                  <h4 className="text-sm font-medium text-foreground group-hover:text-brand-500 transition-colors">
                    Create Workflow
                  </h4>
                  ...
                  {filteredResults.map((result: any) => (
                    ...
                    >
                      ...
                      >
                        ...
                        {result.type === 'template' && (
                          <FolderOpen className="w-4 h-4 text-foreground-light" />
                        )}
                      </div>
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {result.indexed && (
                            <Badge
                              variant="secondary"
                              className="text-xs bg-brand-200 text-brand-500"
                            >
                              Indexed
                            </Badge>
                          )}
                        ...
                        <div className="flex items-center gap-4 mt-2 text-xs text-foreground-muted">
                          <Badge
                            variant="secondary"
                            className="text-xs capitalize bg-surface-200 text-foreground-light"
                          >
                            {result.type === 'workflow'
                              ? 'Workflow'
                              : result.type === 'agent'
                          ...
                          {result.messages && <span>{result.messages} Messages</span>}
                          {result.size && <span>{result.size}</span>}
                          {result.uses && <span>{result.uses} uses</span>}

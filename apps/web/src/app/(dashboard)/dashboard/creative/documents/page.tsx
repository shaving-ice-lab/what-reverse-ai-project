...
const documents = [
  {
    ...
    type: 'blog',
    excerpt:
      '2026 smart domain development trends: large language models, multimodal AI and agents...',
    wordCount: 2500,
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-description">Manage all creative content you generate</p>
            </div>
          ...
          <div className="page-grid grid-cols-3">
            <div className="page-panel p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-stat-number text-foreground">{stats.total}</div>
            ...
            <div className="page-panel p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-stat-number text-foreground">{stats.starred}</div>
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-foreground-muted truncate mb-2">{doc.excerpt}</p>
                ...
                {filteredDocuments.map((doc) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      ...
                      {doc.starred && <Star className="w-4 h-4 text-brand-500 fill-brand-500" />}
                    </div>
                    <h3 className="text-[13px] font-medium text-foreground mb-1 group-hover:text-brand-500 transition-colors line-clamp-1">
                      {doc.title}
                    </h3>
                    <p className="text-xs text-foreground-muted mb-3 line-clamp-2">{doc.excerpt}</p>

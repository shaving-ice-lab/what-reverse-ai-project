...
export default function CreativePage() {
  ...
  return (
    <PageWithSidebar sidebar={<CreativeSidebar />} sidebarTitle="Creative" sidebarWidth="narrow">
      {/* PageHeader */}
      <PageHeader
      ...
      <div className="space-y-6">
        ...
        {/* TodayTip */}
        <SettingsSection title="Today's tip" description="Creative suggestion" compact>
        ...
        {/* CreativeType */}
        <SettingsSection title="Creative type" description="Select a suitable generation method">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            {creativeTypes.map((type) => (
              ...
              >
                ...
                <p className="text-[11px] text-foreground-muted mt-1">{type.description}</p>
              </Link>
            ))}
          </div>
        </SettingsSection>
            ...
            {recentDocuments.map((doc) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px] text-foreground-muted mt-0.5">{doc.updatedAt}</p>
                </div>
                <ChevronRight className="w-3.5 h-3.5 text-foreground-muted group-hover:text-foreground-light transition-colors shrink-0" />
              </Link>
            ))}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-foreground-light">Let AI help you brainstorm</p>
              </div>
            </div>

    ...
    <div className="page-section p-6 space-y-6">
      <div className="page-header">
        <div>
          ...
          <p className="page-description">Complete key config to unlock ReverseAI automation</p>
        </div>
        <div className="page-toolbar">
          ...
          <Button asChild size="sm" className="bg-brand-500 hover:bg-brand-600 text-background">
        ...
        {milestones.map((milestone) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-xs text-foreground-muted">{milestone.label}</p>
              <p className="text-sm font-semibold text-foreground mt-1">{milestone.value}</p>
            </div>
          )
        })}
      </div>
          ...
          <div className="page-panel-header flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="page-panel-description">Complete key steps to unlock all features</p>
              </div>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-foreground-light mt-1">{step.description}</p>
                    </div>

                    <div className="flex items-center gap-3 shrink-0">
                      <div className="flex items-center gap-1 text-xs text-foreground-light">
                        <Star className="w-4 h-4 text-warning" />+{step.points} XP
                      </div>
                      <ChevronRight
                        className={cn(
                          'w-4 h-4',
            ...
            <div className="p-6 space-y-4">
              {nextStep ? (
                <div className="rounded-md border border-border bg-surface-75/60 p-4">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-start gap-3">
                      <div className="p-2 rounded-md bg-brand-200/60">
                        {NextStepIcon && <NextStepIcon className="w-4 h-4 text-brand-500" />}
                      </div>
                      <div>
                        <p className="text-sm font-medium text-foreground">{nextStep.title}</p>
                        <p className="text-xs text-foreground-light mt-1">{nextStep.description}</p>
                      </div>
                    </div>
                    <Badge
                      variant="secondary"
                ...
                <div className="rounded-md border border-brand-400/40 bg-brand-200/30 p-4 text-sm text-foreground">
                  🎉 You've completed all getting started tasks! We suggest browsing the Template
                  Gallery or updating your Account Settings.
        ...
        <div className="page-panel-header flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="page-panel-description">Start building automation from core modules</p>
            </div>
          </div>
          <Badge variant="secondary" className="bg-surface-200 text-foreground-light">
          ...
          {features.map((feature) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-xs text-foreground-light mt-1">{feature.description}</p>
        ...
        <div className="page-panel-header flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="page-panel-description">Scenario-based learning paths and docs</p>
            </div>
          </div>
          <Badge variant="secondary" className="bg-surface-200 text-foreground-light">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge variant="secondary" className={cn('text-[11px]', tone.badge)}>
                      {tone.label}
                    </Badge>
                  </div>
                  <p className="text-xs text-foreground-light mt-1">{resource.description}</p>
                </div>
      ...
      <div className="page-grid lg:grid-cols-2">
        <div className="page-panel">
          <div className="page-panel-header flex items-center gap-3">
            ...
            <div>
              ...
              <p className="page-panel-description">Boost your productivity with shortcuts</p>
            </div>
          </div>
        ...
        <div className="page-panel border-brand-400/50 bg-brand-200/20">
          <div className="p-6 flex items-start gap-4">
            ...
            <div>
              <h3 className="text-sm font-medium text-foreground mb-1">Invite Friends</h3>

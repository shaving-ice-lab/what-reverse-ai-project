...
export default function NewWorkflowPage() {
  ...
  const canProceed = step === 1 ? !!selectedTemplate : workflowName && selectedTrigger
        ...
        <div className="page-grid lg:grid-cols-[minmax(0,1fr)_320px]">
          <div className="space-y-6">
                      ...
                      {triggers.map((trigger) => (
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-xs text-foreground-muted">{trigger.description}</p>
                          </div>
                        </button>
                      ))}
                    </div>
            ...
            <div className="page-panel p-4 flex flex-wrap items-center justify-between gap-3">
              ...
              <Button onClick={handleNext} disabled={!canProceed || isCreating} size="sm">
                {isCreating ? (
                  <>
                ...
                <div className="page-panel p-4 space-y-3">
                  ...
                  <div className="space-y-2 text-xs">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-foreground">{workflowName || 'Not named yet'}</span>
                    </div>
                    <div className="flex items-center justify-between">

            ...
            <div className="flex items-center gap-2">
              ...
              <Link href={`/editor/${workflow.id}`}>
                <Button
                  variant="outline"
                  size="sm"
                  className="border border-border text-foreground-light hover:bg-surface-200"
                >
      ...
      <div className="page-section p-6">
        ...
        {activeTab === 'overview' && (
          <div className="space-y-8">
            ...
            <div
              className={cn('page-panel', isRunning ? 'border-brand-400/30 bg-brand-200/20' : '')}
            >
            ...
            <div className="page-grid sm:grid-cols-2 lg:grid-cols-4">
              {overviewStats.map((stat) => (
                <div key={stat.label} className="page-panel p-5">
                  ...
                  <div className="text-stat-number text-foreground mb-1">{stat.value}</div>
                  ...
                  {mockNodes.map((node, index) => (
                    <div key={node.id} className="flex items-center">
                      <div className="p-3 rounded-md bg-surface-200 border border-border min-w-[140px]">
                        <div className="text-xs text-foreground-muted mb-1">{node.type}</div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <span className="text-xs text-foreground-muted ml-2">{exec.trigger}</span>
                        </div>
                      </div>
          ...
          <div className="space-y-8">
            <div className="page-panel">
              ...
              <div className="p-6 space-y-4">
                <div>
                  ...
                  <Input
                    value={workflow.name}
                    className="h-9 bg-surface-100 border border-border text-foreground"
                  />
                </div>
            ...
            <div className="page-panel">
              <div className="page-panel-header">
                ...
                <div className="page-panel-description">
                  Configure trigger type and execution time
                </div>
              </div>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 p-4 rounded-md bg-surface-100 border border-border">
                  <div>
                    ...
                    <div className="text-xs text-foreground-muted">
                      Auto-stop when specified time is exceeded
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    <Input
                      value="30"
                      type="number"
                      className="w-24 h-9 bg-surface-100 border border-border text-foreground"
                    />
            ...
            <div className="page-panel border-destructive/30 bg-destructive-200/60">
              <div className="page-panel-header">
                ...
                <div className="text-xs text-foreground-light">
                  Deleting the workflow cannot be undone. All execution records will also be
                  deleted.
                </div>
              </div>
              ...
              <div className="p-6">
                <Button
                  variant="outline"
                  className="text-destructive border border-destructive/30 hover:bg-destructive-200"
                >

...
export default function ReviewQueuePage() {
  ...
  const hasFilters = Boolean(
    search || statusFilter !== 'all' || itemTypeFilter !== 'all' || priorityFilter !== 'all'
  )
  ...
  return (
    <PageContainer className="space-y-6">
      ...
      <TabNav tabs={statusTabs} activeTab={statusFilter} onChange={handleStatusChange} />
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Select
            ...
            onValueChange={(v) => setItemTypeFilter(v as ReviewItemType | 'all')}
          >
          ...
          <Select
            ...
            onValueChange={(v) => setPriorityFilter(v as ReviewPriority | 'all')}
          >
            <SelectTrigger className="h-9 w-[140px]">
              ...
              {reviews.map((review) => {
                ...
                return (
                  <Card
                    ...
                    hover="interactive"
                    interactive
                    className={cn('group', isSelected && 'border-brand-400/60 bg-brand-200/40')}
                    onClick={() => {
                      if (isBatchMode) {
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <Badge variant={status.badge} size="xs" className="gap-1">
                            <StatusIcon
                              className={cn(
                                'w-3 h-3',
                                review.status === 'in_review' && 'animate-spin'
                              )}
                            />
                            {status.label}
                          </Badge>

...
const actionTypes = {
 ...
 delete: { label: "Delete", icon: Trash2, color: "text-destructive-400", bg: "bg-destructive-200/70" },
 ...
 logout: { label: "Sign Out", icon: LogOut, color: "text-foreground-light", bg: "bg-surface-200/70" },
 settings: { label: "Settings", icon: Settings, color: "text-foreground-light", bg: "bg-surface-200/70" },

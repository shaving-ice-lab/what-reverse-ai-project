...
const availableEvents = [
 ...
 { group: "Team", events: ["team.member.added", "team.member.removed", "team.member.role.changed"] },
 { group: "Billing", events: ["billing.subscription.created", "billing.subscription.cancelled", "billing.payment.success", "billing.payment.failed"] },
...
const statusConfig = {
 ...
 error: { label: "Error", color: "text-destructive", bg: "bg-destructive-200", dot: "bg-destructive" },
};
...
<h3 className="text-base font-medium text-foreground mb-2">No webhooks</h3>
 ...
 <span>
 total: {webhook.totalDeliveries.toLocaleString()} times
 </span>
 </div>

...
const achievements = [
  {
    id: '1',
    name: 'User',
    description: 'Early sign-up user',
    icon: Crown,
    color: 'text-brand-500',
...

  {
    id: '3',
    name: 'AI explorer',
    description: 'Use 3 or more AI models',
    icon: Sparkles,
    color: 'text-foreground-light',
    bgColor: 'bg-surface-200',
    unlocked: true,
...

  {
    ...
    description: 'Share template used 100+ times',
    icon: Heart,
    color: 'text-brand-500',
    bgColor: 'bg-brand-200',
    unlocked: true,
...

  {
    id: '5',
    name: 'Active user',
    description: 'Use platform 30 days in a row',
    icon: Flame,
    color: 'text-brand-500',
    bgColor: 'bg-brand-200',
    unlocked: false,
...

  {
    id: '6',
    name: 'Code',
    description: 'Generate code 1000+ lines',
    icon: Code,
    color: 'text-brand-500',
    bgColor: 'bg-brand-200',
    unlocked: false,
...
const recentActivities = [
...

  {
    id: '2',
    type: 'conversation',
    title: 'Completed GPT-4 Conversation',
    time: '3 hours ago',
    icon: MessageSquare,
  },
...

  {
    id: '4',
    type: 'template',
    title: 'Shared Template: Data Analytics Report',
    time: '2 days ago',
    icon: Layers,
  },
            ...
            <div className="flex flex-col md:flex-row md:items-end gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-[13px] text-foreground-light mt-3 max-w-2xl">
                  {user?.bio ||
                    'AI automation enthusiast, focused on improving productivity and exploring smart solutions.'}
                </p>
            ...
            {userStats.map((stat) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    className={cn(
                      'h-9 w-9 rounded-md border border-border/70 flex items-center justify-center',
                      stat.bgColor
                    )}
                  >
                ...
                <div className="space-y-6">
                  ...
                  <div className="page-panel">
                    <div className="page-panel-header flex items-center justify-between">
                      ...
                      <Link
                        href="#"
                        className="text-xs text-brand-500 hover:text-brand-600 hover:underline underline-offset-4"
                      >
                        View all
                      </Link>
                    </div>
              ...
              <div className="page-panel overflow-hidden">
                ...
                <div className="divide-y divide-border">
                  {recentActivities.map((activity) => (
                    <div
                      key={activity.id}
                      className="p-4 flex items-start gap-4 hover:bg-surface-75 transition-colors"
                    >

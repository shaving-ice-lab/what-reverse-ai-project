              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-foreground-muted">
                    Enable page animation and transition effects
                  </p>
                </div>
            ...
            <div className="p-6 flex items-center justify-between">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="outline"
                    className="min-w-[160px] justify-between border-border text-foreground-light"
                  >
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="outline"
                      className="min-w-[180px] justify-between border-border text-foreground-light"
                    >
                      <span className="flex items-center gap-2">
                  ...
                  <DropdownMenuContent>
                    {defaultModels.map((model) => (
                      <DropdownMenuItem key={model.id} onClick={() => setDefaultModel(model.id)}>
                        <div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-foreground-muted">
                    Auto-save workflow and document changes
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-foreground-muted">
                    Play a sound when an action completes
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-foreground-muted">
                    Show a quick start guide after signing in
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-foreground-muted">
                    Default way to display workflow list
                  </p>
                </div>
                <div className="flex items-center gap-2">
                  <button

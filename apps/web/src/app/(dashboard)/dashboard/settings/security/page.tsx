            ...
            <div className="p-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[13px] text-foreground-light">
                  Your account has basic security. We recommend enabling two-step verification for
                  stronger security.
                </p>
              </div>
            </div>
                ...
                {newPassword && (
                  <div className="mt-2">
                    ...
                    <p className="text-xs text-foreground-muted mt-1">
                      We recommend using 10+ characters with uppercase and lowercase letters and
                      numbers
                    </p>
                  </div>
                )}
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="page-panel-description mt-1">
                      Use a verification app for enhanced account security
                    </p>
                  </div>
                </div>
                <Badge
              ...
              {showSetup2FA && (
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <p className="text-[13px] text-foreground-light mb-2">
                ...
                <div
                  ...
                  className={cn(
                    ...
                    device.isCurrent
                      ...
                      : 'bg-surface-100/60 border-border'
                  )}
                >
                  ...
                  {!device.isCurrent && (
                    <Button
                      variant="ghost"
                      size="sm"
                      className="text-destructive hover:text-destructive hover:bg-surface-200"
                    >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        {record.status === 'blocked' && (
                          <Badge
                            variant="secondary"
                            className="bg-destructive-200 text-destructive text-xs"
                          >
                            Blocked
                          </Badge>
                        )}

  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        {isActive && (
          <Badge className="text-xs bg-brand-200 text-brand-500 border-brand-400">Current</Badge>
        )}
      </div>
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          ...
          {model.details?.parameterSize && (
            <span className="text-xs text-foreground-muted">{model.details.parameterSize}</span>
          )}
        </div>
    ...
    <div className="p-4 rounded-md bg-surface-100 border border-border">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[13px] font-medium text-foreground">Downloading {modelName}</span>
        </div>
        <Button
          variant="ghost"
          size="sm"
      ...
      <div className="space-y-6">
        ...
        <SettingsSection
          ...
          action={
            ...
            >
              <RefreshCw
                className={cn('h-4 w-4 mr-1.5', status === 'checking' && 'animate-spin')}
              />
              Refresh
            </Button>
          }

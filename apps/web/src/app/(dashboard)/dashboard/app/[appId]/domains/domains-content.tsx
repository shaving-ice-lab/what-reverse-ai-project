...
export function DomainsPageContent({ workspaceId, appId }: DomainsPageProps) {
  ...
  const [selectedVerification, setSelectedVerification] = useState<DomainVerificationInfo | null>(
    null
  )
  ...
  const previewTxtValue =
    verificationPreview?.txt_value || verificationTarget?.verification_token || ''
  ...
  const txtName =
    ...
    (selectedDomain?.domain ? `${defaultTxtPrefix}.${selectedDomain.domain}` : '')
            ...
            <div className="flex items-center justify-between p-3 rounded-md bg-surface-75">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-foreground-muted">HTTPS Auto-Enabled</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  className="h-8 w-8"
                  onClick={() =>
                    copyToClipboard(`https://${workspace?.slug}.agentflow.app/${app?.slug}`)
                  }
                >
                ...
                <div className="flex flex-wrap items-end justify-between gap-3">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    >
                      ...
                      verificationTarget?.status === 'active'
                        ? 'Re-verify'
                        : 'Verify Now'}
                    </Button>
                  </div>
                ...
                {verificationTarget && (
                  <div className="rounded-md border border-border bg-surface-75 p-4">
                    ...
                    <div className="mt-3 text-[11px] text-foreground-muted">
                      DNS records can take minutes to hours to take effect. Please click Verify
                  ...
                  {sortedDomains.map((domain) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-[11px] text-foreground-muted">{verificationLabel}</div>
                        ...
                        <div className="flex items-center justify-end gap-2">
                          ...
                          {domain.status === 'verified' && (
                            ...
                            >
                              <RefreshCw
                                className={cn('w-4 h-4 mr-1.5', isVerifying && 'animate-spin')}
                              />
                              Re-verify
                            </Button>
                          )}
          ...
          <DialogContent className="sm:max-w-md bg-surface-100 border-border">
            <DialogHeader>
              ...
              <DialogDescription className="text-foreground-light">
                Enter the domain you want to bind. After binding, you'll need to configure DNS
              ...
              <div className="p-4 rounded-md bg-surface-75 border border-border">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] text-foreground-muted">Record Value</span>
                    <div className="flex items-center gap-2">
                      <span className="text-[12px] font-mono text-foreground">{cnameTarget}</span>
                      <Button
                        variant="ghost"
                        size="icon"
                        className="h-6 w-6"

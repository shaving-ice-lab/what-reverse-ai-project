...
export default function AchievementsPage() {
  ...
  const unlockedRareCount = achievements.filter(
    (achievement) =>
    ...
    <div className="page-section p-6 space-y-6">
      ...
      <div className="page-grid sm:grid-cols-2 xl:grid-cols-4">
        ...
        <div className="page-panel p-4">
          ...
          <p className="mt-1 text-xs text-foreground-muted">{nextLevelNeed} XP to next level</p>
        ...
        <div className="page-panel p-4">
          ...
          <div className="mt-3 flex items-baseline gap-2">
            <span className="text-stat-number text-foreground tabular-nums">#{userStats.rank}</span>
            <span className="text-xs text-foreground-muted">global</span>
          </div>
          <p className="mt-1 text-xs text-foreground-muted">
            Continuously unlocking achievements will improve your ranking.
          </p>
        </div>
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex items-center gap-1 text-xs font-medium text-brand-500 shrink-0">
                        <Sparkles className="w-3.5 h-3.5" />+{achievement.xp}
                      </div>
                    </div>
                    ...
                    <div className="mt-4">
                      {achievement.unlocked ? (
                        <div className="flex items-center justify-between text-xs">
                          ...
                          <span className="text-foreground-muted">{achievement.unlockedAt}</span>
                        </div>
                      ) : (
                        <div className="space-y-2">
                          <div className="flex items-center justify-between text-xs">

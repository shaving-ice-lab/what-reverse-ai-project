...
describe('Component render can test', () => {
  ...
  describe('Node data process can', () => {
    it('Generate 100 nodes should complete at 10ms', async () => {
      const result = await benchmark('Generate 100 Node', () => generateMockNodes(100), {
        iterations: 100,
      })
    ...
    it('Generate 500 nodes should complete at 50ms', async () => {
      const result = await benchmark('Generate 500 Node', () => generateMockNodes(500), {
        iterations: 50,
      })
    ...
    it('Generate 1000 nodes should complete at 100ms', async () => {
      const result = await benchmark('Generate 1000 Node', () => generateMockNodes(1000), {
        iterations: 20,
      })
  ...
  describe('Edge data process can', () => {
    it('Generate 100 edges should complete at 5ms', async () => {
      const result = await benchmark('Generate 100 Edge', () => generateMockEdges(101), {
        iterations: 100,
      })
    ...
    it('Generate 500 edges should complete at 20ms', async () => {
      const result = await benchmark('Generate 500 Edge', () => generateMockEdges(501), {
        iterations: 50,
      })
  ...
  describe('JSON sequence can', () => {
    ...
    it('Sequence 100 node workflow should complete at 5ms', async () => {
      const result = await benchmark('Sequence workflow', () => JSON.stringify(workflow), {
        iterations: 100,
      })
    ...
    it('Parse 100 node workflow should complete at 5ms', async () => {
      ...
      const result = await benchmark('Sequence workflow', () => JSON.parse(jsonStr), {
        iterations: 100,
      })
  ...
  describe('Deep copy operations can', () => {
    ...
    it('Deep copy should complete at 2ms', async () => {
      ...
      const result = await benchmark('Deep copy', () => JSON.parse(JSON.stringify(obj)), {
        iterations: 100,
      })
    ...
    it('Structured clone should complete at 2ms', async () => {
      ...
      const result = await benchmark('structuredClone', () => structuredClone(obj), {
        iterations: 100,
      })

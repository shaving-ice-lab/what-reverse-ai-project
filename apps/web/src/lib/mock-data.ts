...
export const workflowTemplates: WorkflowTemplate[] = [
 ...
 description: "Automatically categorize incoming emails and execute different processing flows based on their type",
 icon: "📧",
 ...
 id: "wt-2",
    ...
    description: "Schedule and publish content to multiple social media platforms with multi-format support",
 icon: "📱",
 category: "marketing",
 ...
 id: "wt-3",
    ...
    description: "Use AI to analyze customer feedback sentiment and automatically categorize issues",
 icon: "🎯",
 category: "customer",
 difficulty: "intermediate",
 estimatedTime: 8,
 ...
 id: "wt-5",
    ...
    description: "Automatically aggregate daily sales data, generate visual reports, and send them via email",
 icon: "📊",
 category: "data",
 difficulty: "intermediate",
 estimatedTime: 12,
...
export const storeAgents: StoreAgent[] = [
 ...
 description: "Smart writing assistant powered by the latest AI models. Supports multiple writing styles and can generate articles, copy, reports, and more",
 icon: "✍️",
 category: "writing",
 ...
 id: "agent-2",
    ...
    description: "Comprehensive data analytics solution supporting data cleaning, analysis, visualization, and report generation",
 icon: "📊",
 category: "analytics",
 ...
 id: "agent-3",
    ...
    description: "Automatically review code, detect potential issues, and provide optimization suggestions and best practices",
 icon: "🔍",
 ...
 id: "agent-4",
    ...
    description: "24/7 smart customer support with multi-turn conversations, intent recognition, and knowledge base Q&A",
 icon: "🤖",
 ...
 featured: true,
 capabilities: ["Multi-turn Conversation", "Intent Recognition", "Sentiment Analysis", "Knowledge Base"],
 ...
 description: "Quickly generate high-conversion marketing copy with multi-platform adaptation and A/B testing support",
 icon: "📢",
 category: "marketing",
 ...
 featured: false,
 capabilities: ["Multi-platform Adaptation", "A/B Testing", "Optimization", "Audience Analytics"],
 models: ["GPT-4"],
 version: "1.5.0",
 ...
 id: "agent-6",
    ...
    description: "Professional translation tool supporting 100+ languages while preserving style and tone",
 icon: "🌍",
 ...
 featured: true,
 capabilities: ["100+ Languages", "Terminology Management", "Style Preservation", "Batch Translation"],
 models: ["GPT-4", "Claude 3"],
 version: "4.2.0",
...
export const conversationHistory: ConversationItem[] = [
 ...
 id: "conv-1",
    ...
    preview: "Let me help you design this email automation workflow. First, we need to define the trigger conditions...",
 model: "GPT-4",
 ...
 preview: "Based on the data you provided, I've completed the analysis. Here are the key findings: 1) Sales have grown...",
 model: "GPT-4",
 ...
 id: "conv-3",
    ...
    preview: "Let me analyze the potential issues with this component. The main findings and optimization suggestions are...",
 model: "Claude 3",
 ...
 preview: "Here is the product launch announcement draft I've written for you, highlighting key features and user value...",
 model: "GPT-4",
 ...
 preview: "Based on your requirements, I suggest using the following database architecture design. Key considerations include scalability and query performance...",
 model: "GPT-4",
...
export const faqItems: FAQItem[] = [
 ...
 answer: "An Agent is a smart AI assistant that can understand natural language and make decisions to execute tasks. A Workflow is a defined automation flow that executes in fixed steps. Agents are more flexible, while Workflows are more predictable.",
 category: "Features",
 helpful: 189,
 },
 {
 ...
 answer: "Free users can upload files up to 10MB with 1GB total storage. Pro users can upload files up to 50MB with 10GB total storage. Supported formats include PDF, Word, Excel, images, code files, and more.",
...
export const regressionTestCases: RegressionTestCase[] = [
 ...
 id: "rt-3",
    ...
    prompt: "Explain the comparative growth reasons from the table, providing at least 2 verifiable facts.",
 ...
 prompt: "Translate the product feature descriptions to Japanese while maintaining terminology consistency.",
...
export const reviewSamplingStrategy: ReviewSamplingStrategy = {
 ...
 description: "Finance, legal, healthcare, and other high-risk domains require mandatory review",
 },
 {
 id: "t-3",
...
export const sampleApps: SampleApp[] = [
 ...
 id: "sa-1",
    ...
    description: "Process multi-channel inquiries, automatically identify intent and generate structured replies.",
 icon: "🎧",
 category: "Customer Service",
 ...
 id: "sa-2",
    ...
    description: "Automatically generate quotes and delivery plans based on requirements, with multi-version comparison support.",
 icon: "💼",
 ...
 description: "Aggregate trend data and insights to generate one-click market intelligence reports.",
 icon: "📰",
 ...
 description: "Identify risks in documents and provide editing suggestions with a review summary.",
 icon: "🧾",
 category: "Compliance",
 ...
 description: "Provide cited answers based on enterprise knowledge base with multi-source aggregation.",
 icon: "📚",
 category: "Operations",
 ...
 description: "Automatically pull business metrics and generate ready-to-send daily operations report templates.",
 icon: "📈",
...
export const demoDataPacks: DemoDataPack[] = [
 ...
 description: "Multi-channel support conversations and ticket tags, suitable for demoing intent recognition and auto-summarization.",
 format: "json",
 records: 4200,
 fields: 18,
 size: "12.4MB",
 ...
 id: "dd-2",
    ...
    description: "Contains channel, user behavior, and campaign results data for demo attribution analytics.",
 format: "csv",
 records: 12800,
 fields: 22,
 size: "18.1MB",
 ...
 description: "Enterprise knowledge base fragments and Q&A pairs for demoing cited answers and search.",
 format: "parquet",
 records: 7600,
 fields: 12,
 size: "9.7MB",
...
export const demoScaffoldTemplates: DemoScaffoldTemplate[] = [
 ...
 description: "Auto-generate summaries, risk assessments, and follow-up suggestions from support tickets.",
 language: "json",
 ...
 description: "Auto-generate trend insights and actionable suggestions from marketing outreach data.",
 language: "json",
...
export const demoFlowScript: DemoFlowScript = {
 ...
 id: "step-4",
    ...
    actions: ["Showcase regression test cases", "Explain style policies", "Describe risk controls"],
...
export const releaseNoteTemplate: ReleaseNoteTemplate = {
 ...
 summary: "Added regression panel, release cadence and demo scaffolds to improve demo and testing capabilities.",
 highlights: [
 ...
 rollback: "If a P1 alert occurs within 30 minutes after release, roll back to the previous stable version.",
 links: [
...
export const deploymentPipelineStrategy: DeploymentPipelineStrategy = {
 ...
 description: "Standardized flow from code submission to full deployment. Ensures rollback capability and traceability.",
 ...
 freezeRules: ["End-of-month freeze: only hotfixes allowed", "No releases 48h before major events"],
 },
};

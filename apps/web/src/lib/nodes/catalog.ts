...
export const WORKFLOW_NODE_CATEGORIES: WorkflowNodeCategory[] = [
  {
    id: 'ai',
    name: 'AI',
    description: 'Smart generate and inference',
    icon: Bot,
    color: '#8B5CF6',
  },
  {
    id: 'http',
    name: 'HTTP',
    description: 'Interface and integration',
    icon: Globe,
    color: '#3B82F6',
  },
  { id: 'db', name: 'DB', description: 'Data and storage', icon: Database, color: '#10B981' },
  {
    id: 'ui',
    name: 'UI',
    description: 'Interactive and showcase',
  ...
  },
  {
    id: 'utility',
    name: 'Utility',
    description: 'Flow and utility tools',
    icon: Settings,
    color: '#64748B',
  },
]
...
export function listWorkflowNodes(
  options: { includeBuiltin?: boolean; includeExtensions?: boolean } = {}
...
function getWorkflowCategorySummary(
  nodes: WorkflowNodeCatalogEntry[]
): WorkflowNodeCategorySummary[] {

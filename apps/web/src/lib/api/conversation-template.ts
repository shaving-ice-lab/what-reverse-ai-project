...
export const conversationTemplateApi = {
  ...
  async list(params?: ListTemplatesParams): Promise<TemplateListResponse> {
    ...
    if (params?.includeSystem !== undefined)
      searchParams.set('include_system', params.includeSystem.toString())
  ...
  async delete(id: string): Promise<void> {
    await request<{ success: boolean }>(`${API_BASE_URL}/conversation-templates/${id}`, {
      method: 'DELETE',
    })
  },

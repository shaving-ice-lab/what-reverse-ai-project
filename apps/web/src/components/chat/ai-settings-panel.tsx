...
const PARAM_DESCRIPTIONS = {
  temperature: "控制输出的随机性。较高的值使输出更随机，较低的值使输出更集中和确定。",
  maxTokens: "限制生成的最大 token 数量。",
  topP: "核采样参数。控制考虑的 token 概率累积阈值。",
  topK: "Top-K 采样。限制每次只考虑概率最高的 K 个 token。0 表示禁用。",
  frequencyPenalty: "频率惩罚。降低重复词语的出现概率。正值减少重复，负值增加重复。",
  presencePenalty: "存在惩罚。鼓励模型谈论新话题。正值增加多样性，负值减少多样性。",
};

    ...
    <div className={cn('space-y-6', className)}>
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start">
        ...
        <div className="flex-1">
          ...
          <h1 className="text-2xl font-bold text-foreground mb-2">{name || 'Agent Name'}</h1>
      ...
      {longDescription && (
        <div>
          ...
          <div className="p-4 rounded-xl bg-card border border-border">
            <p className="text-sm text-muted-foreground whitespace-pre-wrap">{longDescription}</p>
          </div>
        </div>
      )}

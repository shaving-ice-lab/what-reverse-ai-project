...
import { Gift, CreditCard, Repeat, AlertCircle, Info, DollarSign } from 'lucide-react'
          ...
          {pricingOptions.map((option) => {
            ...
            return (
              ...
              >
                ...
                >
                  <Icon
                    className={cn('w-5 h-5', isSelected ? 'text-primary' : 'text-foreground-light')}
                  />
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-foreground-light mt-1">{option.description}</p>
                </div>
              </button>
            )
          })}
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-foreground-light mt-1">
                Free agents get more exposure and usage, making them great for collecting user
                feedback. You can switch to paid pricing at any time.
              </p>
            </div>
          </div>
        </div>

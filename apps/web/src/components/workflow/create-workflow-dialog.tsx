...
export function CreateWorkflowDialog({ trigger, folderId, onSuccess }: CreateWorkflowDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-[580px] overflow-hidden" onKeyDown={handleKeyDown}>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Create an empty workflow and drag and drop nodes in the editor to build your
                    automation flow
                  </p>
                </div>
              </div>
        ...
        <DialogFooter className="gap-2 sm:gap-2 pt-2">
          <div className="hidden sm:flex items-center text-xs text-muted-foreground mr-auto">
            <kbd className="px-1.5 py-0.5 rounded bg-muted border border-border font-mono text-[10px] mr-1">
              ⌘
            </kbd>
            <kbd className="px-1.5 py-0.5 rounded bg-muted border border-border font-mono text-[10px] mr-1.5">
              Enter
            </kbd>
            Quick create
          </div>

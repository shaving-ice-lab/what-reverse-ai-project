...
const statusConfig = {
  draft: {
    label: "草稿",
    className: "bg-gradient-to-r from-amber-500/15 to-amber-500/5 border border-amber-500/40 text-amber-600 dark:text-amber-400 shadow-sm shadow-amber-500/10",
    icon: Clock,
  ...
  published: {
    label: "已发布",
    className: "bg-gradient-to-r from-emerald-500/15 to-emerald-500/5 border border-emerald-500/40 text-emerald-600 dark:text-emerald-400 shadow-sm shadow-emerald-500/10",
    icon: CheckCircle2,
  ...
  archived: {
    label: "归档",
    className: "bg-gradient-to-r from-muted/10 to-muted/5 border border-border/60 text-muted-foreground/80 shadow-sm",
    icon: Archive,
    ...
    <TooltipProvider delayDuration={300}>
      ...
      >
        ...
        <div className={cn(
          ...
          workflow.status === "draft" && "bg-gradient-to-b from-amber-500 via-amber-400 to-amber-500/50",
          workflow.status === "archived" && "bg-gradient-to-b from-muted-foreground via-muted-foreground/80 to-muted-foreground/50",
              ...
              >
                ...
                <DropdownMenuItem asChild>
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      <span className="font-bold">编辑工作流</span>
                      <span className="text-[10px] text-muted-foreground/70">打开编辑器</span>
                    </div>
                  </Link>
                </DropdownMenuItem>
                {onRun && workflow.status === "published" && (
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      <span className="font-bold">立即运行</span>
                      <span className="text-[10px] text-muted-foreground/70">执行此工作流</span>
                    </div>
                  </DropdownMenuItem>
                )}
                ...
                {onDuplicate && (
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      <span className="font-bold">复制</span>
                      <span className="text-[10px] text-muted-foreground/70">创建副本</span>
                    </div>
                  </DropdownMenuItem>
                )}
                {onExport && (
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[10px] text-muted-foreground/70">下载 JSON 文件</span>
                    </div>
                  </DropdownMenuItem>
                )}
                ...
                {onArchive && workflow.status !== "archived" && (
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      <span className="font-bold">归档</span>
                      <span className="text-[10px] text-muted-foreground/70">移至归档</span>
                    </div>
                  </DropdownMenuItem>
                )}
                {onDelete && (
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[10px] text-destructive/70">永久删除</span>
                    </div>
                  </DropdownMenuItem>
                )}
              </DropdownMenuContent>
                ...
                <TooltipContent side="top" className="text-xs max-w-56 p-3 rounded-xl bg-card/95 backdrop-blur-sm border-border/60">
                  <div className="flex flex-wrap gap-1.5">
                    {tags.slice(2).map((t, i) => (
                      <span key={i} className="px-2.5 py-1 rounded-lg bg-muted/80 text-foreground-light border border-border/30 text-[11px]">{t}</span>
                    ))}
                  </div>
                </TooltipContent>
              </Tooltip>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <span className="group/stat relative flex items-center gap-2.5 px-3.5 py-2 rounded-xl bg-gradient-to-r from-amber-500/12 to-amber-500/5 hover:from-amber-500/25 hover:to-amber-500/12 border border-amber-500/25 hover:border-amber-500/50 transition-all duration-400 cursor-default hover:scale-105 hover:shadow-xl hover:shadow-amber-500/15 overflow-hidden">
                  ...
                  <span className="relative font-black text-amber-600 dark:text-amber-400">{nodeCount}</span>
                </span>
              </TooltipTrigger>
              <TooltipContent side="bottom" className="text-xs px-3 py-2 rounded-xl bg-card/98 backdrop-blur-xl border-border/60 shadow-xl">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <span className="group/stat relative flex items-center gap-2.5 px-3.5 py-2 rounded-xl bg-gradient-to-r from-blue-500/12 to-blue-500/5 hover:from-blue-500/25 hover:to-blue-500/12 border border-blue-500/25 hover:border-blue-500/50 transition-all duration-400 cursor-default hover:scale-105 hover:shadow-xl hover:shadow-blue-500/15 overflow-hidden">
                  ...
                  <span className="relative font-black text-blue-600 dark:text-blue-400">{(workflow.runCount || 0).toLocaleString()}</span>
                </span>
              </TooltipTrigger>
              <TooltipContent side="bottom" className="text-xs px-3 py-2 rounded-xl bg-card/98 backdrop-blur-xl border-border/60 shadow-xl">
                <span className="flex items-center gap-2.5 font-semibold">
                  ...
                  运行 {(workflow.runCount || 0).toLocaleString()} 次
                </span>
              </TooltipContent>
            </Tooltip>
  ...
  return (
    ...
    >
      ...
      <div className="mt-5 flex items-center gap-3 opacity-0 group-hover:opacity-100 transition-all duration-500 delay-200 translate-y-3 group-hover:translate-y-0">
        ...
        <span className="text-xs text-muted-foreground/80 font-medium">快速创建</span>
      </div>
    ...
    <div className="group relative bg-card border border-border/50 rounded-2xl p-5 overflow-hidden hover:border-border/80 transition-colors duration-300">
      ...
      <div className="flex items-start justify-between mb-5">
        <div className="relative">
          ...
          <div className="absolute -top-1.5 -right-1.5 w-4 h-4 rounded-full bg-gradient-to-br from-muted/80 to-muted/50 animate-pulse border-2 border-card" style={{ animationDelay: '300ms' }} />
        </div>
        <div className="flex gap-2">
          {[0, 1, 2].map((i) => (
            ...
            >
              <div className="w-full h-full animate-pulse bg-muted/40" style={{ animationDelay: `${100 + i * 80}ms` }} />
            </div>
          ))}
        </div>
      </div>

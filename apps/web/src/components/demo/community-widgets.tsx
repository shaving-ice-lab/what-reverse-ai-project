...
const mockDiscussions = [
  {
    ...
    preview:
      'I have a workflow that needs to process 100,000+ data entries. The runtime is too long. Any optimization suggestions?',
  ...
  },
  {
    ...
    preview:
      'A week-long support workflow that supports multiple conversations, sentiment analysis, and auto-categorization. Sharing with everyone...',
  ...
  },
  {
    ...
    preview:
      'I want to use Webhook to trigger my workflow, but keep getting request errors. Can anyone check if my config has issues?',
  ...
  },
  {
    ...
    preview:
      'Our company has been using AgentFlow for years. Sharing our production environment experience summary...',
  ...
  },
  {
    ...
    preview:
      'Hope to add GraphQL Subscription as a trigger type. This would enable better integration with existing systems...',
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-start justify-between gap-2 mb-1">
                  <h4 className="font-semibold text-foreground group-hover:text-primary transition-colors line-clamp-1">
                    {discussion.isHot && <Flame className="w-4 h-4 inline mr-1 text-orange-500" />}
                    {discussion.title}
                  </h4>
                </div>

          ...
          return (
            ...
            >
              ...
              <div>
                ...
                <span className="block text-xs text-muted-foreground">{nodeConfig.label}</span>
              </div>
      ...
      {showControls && (
        <div className="flex items-center justify-between px-4 py-3 bg-muted/30 border-t border-border/50">
          <div className="flex items-center gap-2">
            ...
            <Button size="sm" variant="ghost" className="h-8 px-3 rounded-lg" onClick={handleReset}>

            ...
            <React.Fragment key={step.id}>
              ...
              >
                {isCompleted ? (
                  ...
                  <Circle className={cn('w-5 h-5', isCurrent && 'fill-primary/20')} />
                )}
                <span className={cn('text-sm font-medium', compact && 'hidden sm:inline')}>
                  {step.title}
                </span>
              </button>
      ...
      {currentStepData && (
        <div className="bg-card border border-border rounded-2xl p-6 mb-6">
          ...
          <div className="bg-background rounded-xl overflow-hidden mb-4">
            ...
            <div className="p-4">
              <code className="text-sm font-mono text-emerald-400">$ {currentStepData.code}</code>
            </div>
          </div>

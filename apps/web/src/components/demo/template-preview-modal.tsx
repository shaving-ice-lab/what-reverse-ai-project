...
const sampleTemplates: TemplateData[] = [
  {
    ...
    description:
      'GPT-4 powered multi-conversation support with sentiment analysis and auto-categorization',
    longDescription:
      'A complete smart support solution: multi-conversation management, sentiment analysis, intent recognition, and auto ticket categorization. For e-commerce, SaaS, finance, and more. Multi-language support; quick to add to existing support systems.',
  ...
  },
  {
    ...
    longDescription:
      'Data pipeline supporting MySQL, PostgreSQL, MongoDB, API. Extract, clean, convert, and load with validation and error handling.',
    author: 'Data Master',
    authorAvatar: 'D',
            ...
            <div className="space-y-4">
              ...
              <div className="grid sm:grid-cols-3 gap-3">
                {[
                  ...
                  .slice(0, template.nodes > 6 ? 6 : template.nodes)
                  .map((node, i) => (
                    <div
                      key={i}
                ...
                <button
                  onClick={() => {
                    navigator.clipboard.writeText(
                      JSON.stringify({ id: template.id, name: template.name }, null, 2)
                    )
                    setCopied(true)
                    setTimeout(() => setCopied(false), 2000)
                  }}

        ...
        <Tabs defaultValue="link" className="mt-4">
          ...
          <TabsContent value="link" className="mt-4 space-y-4">
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input value={shareUrl} readOnly className="bg-muted border-border" />
                <Button
                  onClick={copyLink}
                  className={cn(
                    'shrink-0',
            ...
            <div className="space-y-4 pt-4 border-t border-border">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">A password is required to access</p>
                </div>
          ...
          <TabsContent value="qrcode" className="mt-4 space-y-4">
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-muted-foreground mt-3">Scan QR code to access</p>
              <Button variant="outline" onClick={downloadQRCode} className="mt-4 border-border">
            ...
            <div className="space-y-2 pt-4 border-t border-border">
              ...
              <div className="rounded-lg border border-border overflow-hidden">
                <div className="bg-muted h-40 flex items-center justify-center">
                  <p className="text-sm text-muted-foreground">Embed content preview</p>
                </div>
              </div>
            </div>
          </TabsContent>
          ...
          <TabsContent value="social" className="mt-4">
            ...
            <div className="mt-4 p-3 rounded-lg bg-muted">
              <p className="text-xs text-muted-foreground">
                When sharing to social platforms, the title and description are included
                automatically. For WeChat sharing, please use the QR code feature.
              </p>
            </div>
          </TabsContent>
        </Tabs>

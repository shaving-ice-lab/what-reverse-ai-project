...
export function SearchResultItem({ result, isActive, onClick, className }: SearchResultItemProps) {
  ...
  return (
    ...
    >
      <div
        className={cn('w-10 h-10 rounded-lg flex items-center justify-center shrink-0', config.bg)}
      >
  ...
  return (
    <div className={cn('', className)}>
      <div className="flex items-center justify-between mb-2 px-2">
        ...
        {hasMore && (
          <button onClick={onShowAll} className="text-xs text-primary hover:underline">
...
export function SearchFilters({ selectedType, onTypeChange, className }: SearchFiltersProps) {

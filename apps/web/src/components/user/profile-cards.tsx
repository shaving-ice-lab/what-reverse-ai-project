      ...
      {showStats && user.stats && (
        <div className="grid grid-cols-3 gap-4 pt-4 border-t border-border">
          <div className="text-center">
            <p className="text-2xl font-bold text-foreground">{user.stats.workflows || 0}</p>
            <p className="text-xs text-muted-foreground">Workflow</p>
          </div>
          <div className="text-center">
            <p className="text-2xl font-bold text-foreground">{user.stats.agents || 0}</p>
            <p className="text-xs text-muted-foreground">Agent</p>
          </div>
          <div className="text-center">
            <p className="text-2xl font-bold text-foreground">{user.stats.conversations || 0}</p>
...
export function MiniUserCard({ user, showRole = false, onClick, className }: MiniUserCardProps) {
  return (
    <div
      onClick={onClick}
      className={cn(
...
export function UserActivityCard({ user, activity, className }: UserActivityCardProps) {
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-1">
          ...
          <Badge variant="secondary" className={cn(config.bg, config.color, 'text-xs')}>
            ...
            {activity.type === 'conversation' && 'Conversation'}

...
export function NodeDetailModal({
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'code' | 'versions' | 'reviews'>(
    'overview'
  )
            ...
            <div className="p-6 border-b border-border shrink-0">
              <div className="flex items-start gap-5">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <Button variant="outline" size="icon" onClick={handleStar} disabled={isStarring}>
                    {isStarring ? (
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              {activeTab === 'versions' && (
                <div className="space-y-3">
                  {(showAllVersions ? node.versions : node.versions.slice(0, 5)).map(
                    (version, index) => (
                      <div
                        key={version.version}
                        className={cn(

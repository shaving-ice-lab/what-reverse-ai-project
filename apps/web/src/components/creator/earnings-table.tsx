      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-surface-200 border-border">
            ...
            <TableHead className="text-table-header">Source</TableHead>
            <TableHead className="text-table-header text-right">Total Amount</TableHead>
            <TableHead className="text-table-header text-right">Earnings</TableHead>
            <TableHead className="text-table-header">Status</TableHead>
            <TableHead className="text-table-header">Time</TableHead>
            <TableHead className="text-table-header w-10"></TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
              ...
              >
                ...
                <TableCell className="py-4">
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <TypeIcon
                        className={cn('h-4 w-4', typeConfig?.color || 'text-foreground-muted')}
                      />
                    </div>
                    <div>

        ...
        <div className="space-y-5 py-4">
            ...
            <Select value={provider} onValueChange={(v) => setProvider(v as ApiKeyProvider)}>
              ...
              <SelectContent className="rounded-xl">
                {Object.values(PROVIDER_CONFIGS).map((config) => (
                  <SelectItem key={config.id} value={config.id} className="rounded-lg py-3">
                    <div className="flex items-center gap-3">
          ...
          <div className="space-y-3">
            <Label htmlFor="apiKey" className="text-sm font-medium flex items-center gap-2">
              API Key
              <span className="px-1.5 py-0.5 text-[9px] font-bold uppercase text-amber-600 dark:text-amber-400 bg-amber-500/10 rounded"></span>
            </Label>

  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        ...
        {variant !== 'compact' && <div className="h-3 w-3/4 rounded bg-muted animate-pulse" />}
      </div>
    </div>
  )
}
...
export function FeatureCardGrid({
  ...
  return <div className={cn('grid gap-4 sm:gap-5', gridCols[columns], className)}>{children}</div>
}

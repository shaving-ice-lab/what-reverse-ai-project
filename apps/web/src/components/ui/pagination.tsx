...
function PaginationInfo({
  ...
  return (
    <p className={cn("text-sm text-foreground-light", className)}>
      显示 <span className="font-medium text-foreground">{start}</span> - <span className="font-medium text-foreground">{end}</span> 条，
      共 <span className="font-medium text-foreground">{total.toLocaleString()}</span> 条
    </p>
  )
}

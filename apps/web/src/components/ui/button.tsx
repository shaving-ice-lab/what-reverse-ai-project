...
/**
 * Button ButtonComponent - Supabase Style: BrandGreenmainButton
 */
const buttonVariants = cva(
  ...
  ].join(''),
  {
    variants: {
      variant: {
        // mainButton - Supabase BrandGreen
        default: ['bg-brand-500 text-background', 'hover:bg-brand-600', 'active:bg-brand-400'].join(
          ''
        ),
        // timesneedButton - Supabase surface Background
        secondary: [
          'bg-surface-100 text-foreground border border-border',
          'hover:bg-surface-200 hover:border-border-strong',
          'active:bg-surface-400',
        ].join(''),
        // DamageButton - Outline
        destructive: [
        ...
        // DamageButton - Fill
        'destructive-fill': ['bg-destructive-400 text-white', 'hover:bg-destructive'].join(''),
        // GhostButton - Supabase Style
        ghost: [
        ...
        // CTA Button
        cta: ['bg-brand-500 text-background-studio font-semibold', 'hover:bg-brand-600'].join(''),
        // GradientButton
        gradient: [

    ...
    return (
      ...
      >
        ...
        <ScrollBar
          ...
          className={autoHide ? 'opacity-0 hover:opacity-100 transition-opacity' : ''}
        />
    ...
    <ScrollAreaPrimitive.ScrollAreaScrollbar
      ...
      className={cn(
        ...
        orientation === 'vertical' &&
          cn('h-full border-l border-l-transparent p-[1px]', sizeStyles[size]),
        orientation === 'horizontal' &&
          cn('flex-col border-t border-t-transparent p-[1px]', sizeStyles[size]),
        className
      )}
      {...props}
    >

          ...
          <React.Fragment key={index}>
            ...
            >
              ...
              >
                ...
                {step.description && (
                  <span
                    className={cn(sizeStyles[size].description, 'text-foreground-light mt-0.5')}
                  >
                    {step.description}
                  </span>
                )}
            ...
            {showConnector && !isLast && (
              <div
                className={cn(
                  ...
                  status === 'completed' || index < currentStep ? 'bg-primary' : 'bg-border'
                )}
              />
            )}
          </React.Fragment>
...
function StepContent({ step, currentStep, children, className }: StepContentProps) {
...
export { Stepper, StepIndicator, StepContent, StepperActions, ProgressStepper }
export type {
  StepConfig,
  StepStatus,
  StepperProps,

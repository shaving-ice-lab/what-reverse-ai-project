  ...
  <TabsPrimitive.Content
    ...
    className={cn(
      ...
      animated && [
        ...
        animationDirection === "fade" && "data-[state=active]:fade-in-0 data-[state=inactive]:fade-out-0",
        animationDirection === "horizontal" && "data-[state=active]:slide-in-from-right-4 data-[state=inactive]:slide-out-to-left-4",
        animationDirection === "vertical" && "data-[state=active]:slide-in-from-bottom-4 data-[state=inactive]:slide-out-to-top-4",
        "duration-200",
      ],
      className
    )}

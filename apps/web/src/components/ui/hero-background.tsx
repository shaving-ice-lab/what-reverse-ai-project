    ...
    <div className={cn('absolute inset-0 overflow-hidden pointer-events-none', className)}>
      ...
      <style jsx>{`
        @keyframes wave {
          ...
          100% {
            d: path(
              'M0,160L48,170C96,180,192,200,288,192C384,184,480,144,576,154C672,165,768,229,864,234C960,240,1056,190,1152,165C1248,140,1344,140,1392,140L1440,140L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z'
            );
          }
          50% {
            d: path(
              'M0,192L48,186C96,181,192,169,288,181C384,192,480,224,576,218C672,213,768,165,864,154C960,144,1056,165,1152,181C1248,197,1344,208,1392,213L1440,218L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z'
            );
          }
        }
        .animate-wave {

...
export function CardSkeleton({ className }: CardSkeletonProps) {
  return (
    <div className={cn('rounded-xl p-6 space-y-3 border border-border bg-card', className)}>
...
export function FullscreenLoader({ visible, message = 'Loading...' }: FullscreenLoaderProps) {
...
export function Skeleton({ className, style }: SkeletonProps) {
  return <div className={cn('rounded-lg animate-shimmer bg-muted', className)} style={style} />
}

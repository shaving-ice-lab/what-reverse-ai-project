  ...
  (
    ...
    return (
      <div ref={ref} className={cn('relative overflow-hidden', className)} {...props}>
        {/* Background */}
        <div className={cn('absolute inset-0 -z-10', fixed && 'fixed')} style={{ opacity }}>
          ...
          {variant === 'particles' && (
            <div className="absolute inset-0">
              {[...Array(20)].map((_, i) => (
                <div
                  key={i}
                  className={cn('absolute rounded-full', animated && 'animate-float')}
                  style={{
...
const GlowDot = React.forwardRef<HTMLDivElement, GlowDotProps>(
  (
    ...
    return (
      <div
        ref={ref}
        className={cn('absolute rounded-full', animated && 'animate-glow-pulse', className)}
        style={{
          width: size,
          height: size,
...
const GlowLine = React.forwardRef<HTMLDivElement, GlowLineProps>(
  (
    ...
    return (
      <div
        ref={ref}
        className={cn('absolute pointer-events-none', animated && 'animate-pulse', className)}
        style={{
...
export { AnimatedBackground, FloatingOrb, GlowDot, GlowLine, PulseRing, GradientSpot, GridGlow }

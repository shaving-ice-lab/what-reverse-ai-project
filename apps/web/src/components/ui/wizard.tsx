  ...
  return (
    <WizardContext.Provider value={contextValue}>
      <div className={cn('w-full', className)}>
        {/* ProgressIndicator */}
        {showProgress && <WizardProgress steps={steps} currentStep={currentStep} />}

        {/* StepContent */}
        <div className="mt-8">{children || currentStepData.content}</div>
    ...
    return (
      <div className={cn('space-y-2', className)}>
        <div className="flex items-center justify-between text-sm">
          ...
          <span className="text-foreground-light">{steps[currentStep].title}</span>
        </div>
        ...
        return (
          ...
          >
            ...
            <div className="flex-1 pb-4">
              ...
              {step.description && (
                <p className="text-sm text-foreground-light mt-1">{step.description}</p>
              )}
              {isActive && (

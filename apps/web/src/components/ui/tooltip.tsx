...
const tooltipVariants = cva(
  ...
  ],
  {
    variants: {
      variant: {
        default:
          'bg-surface-100 text-foreground px-2.5 py-1.5 border border-border shadow-md shadow-black/20',
        ...
        error:
          'bg-destructive-200 text-destructive px-2.5 py-1.5 border border-destructive/30 shadow-lg',
        glass: [
          'bg-surface-100',
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              {title && <div className="font-medium text-foreground mb-0.5">{title}</div>}
              {description && (

...
export const editorOnboardingSteps: OnboardingStep[] = [
  ...
  },
  {
    ...
    title: 'Node Panel',
    description:
      'Select a node type from the left panel and drag and drop it onto the canvas to add a node',
  ...
  },
  {
    ...
    title: 'Run Workflow',
    description:
      'Click the Run button to execute the workflow and view execution status in real-time',

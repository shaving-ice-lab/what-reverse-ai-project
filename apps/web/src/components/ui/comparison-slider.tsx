...
export function ComparisonSlider() {
  ...
  return (
    <div className="w-full">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="hidden md:block">
                <div className="bg-primary-foreground rounded-lg p-4 text-xs font-mono overflow-hidden max-h-[200px]">
                  <pre className="text-red-300/70 whitespace-pre-wrap">
                    {beforeData.codeExample}
                  </pre>
                </div>
              </div>
            </div>
      ...
      {/* Tip */}
      <p className="text-center text-sm text-muted-foreground mt-4">← Drag slider to compare →</p>
    </div>
  )
}

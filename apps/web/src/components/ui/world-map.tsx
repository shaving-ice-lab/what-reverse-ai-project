    ...
    >
      ...
      >
        ...
        <g stroke="hsl(var(--primary))" strokeWidth="0.1" strokeOpacity="0.2" fill="none">
          ...
          <path
            d="M48,15 Q65,10 77,17"
            className="animate-pulse"
            style={{ animationDelay: '0.5s' }}
          />
          <path
            d="M25,18 Q40,30 77,20"
            className="animate-pulse"
        ...
        >
          ...
          <div
            className={cn(
              ...
              city.active ? 'bg-primary shadow-lg shadow-primary/50' : 'bg-muted-foreground/50'
            )}
          />
...
export function SimpleWorldMap({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn(

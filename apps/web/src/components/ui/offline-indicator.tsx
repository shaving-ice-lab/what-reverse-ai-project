  ...
  return (
    <div className="grid grid-cols-3 gap-2 text-center">
      <div className="p-2 rounded-md bg-[var(--color-muted)]">
        ...
        <div className="text-xs text-[var(--color-muted-foreground)]">待处理</div>
      </div>
      <div className="p-2 rounded-md bg-[var(--color-muted)]">
        ...
        <div className="text-xs text-[var(--color-muted-foreground)]">处理中</div>
      </div>
      <div className="p-2 rounded-md bg-[var(--color-muted)]">
        ...
        <div className="text-xs text-[var(--color-muted-foreground)]">失败</div>
      </div>
    </div>
  );
}
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <div
            className={cn(
              ...
              status === 'offline' && 'bg-[var(--color-destructive-muted)] text-[var(--color-destructive)]',
        ...
        <TooltipContent>
          <div className="text-xs">
            ...
            {queueState.pendingCount > 0 && (
              <p className="mt-0.5">{queueState.pendingCount} 待同步</p>
            )}
          </div>
        </TooltipContent>
      </Tooltip>

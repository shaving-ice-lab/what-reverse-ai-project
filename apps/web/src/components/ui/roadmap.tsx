...
const roadmapData: RoadmapItem[] = [
  ...
  },
  {
    ...
    status: 'completed',
    icon: Shield,
    features: ['Team workspaces', 'RBAC permission control', 'Audit logging', 'SSO sign-in'],
  },
  {
    id: 'q3-2024',
    quarter: 'Q3',
    ...
    description:
      'Deep integration with multiple large language models and smart workflow optimization',
    status: 'completed',
    icon: Brain,
    features: [
  ...
  return (
    <div className="w-full">
          ...
          {roadmapData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Content Card */}
                <div className={cn(isLeft ? 'md:col-start-2' : 'md:col-start-1 md:direction-ltr')}>
                  <div
                    className={cn(
      ...
      <div className="mt-12 text-center">
        <p className="text-muted-foreground mb-4">Want to see more product plans?</p>
        <a
          href="/changelog"

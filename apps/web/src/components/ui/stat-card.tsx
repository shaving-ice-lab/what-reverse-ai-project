    ...
    >
      ...
      <div className="flex items-start justify-between mb-4">
        ...
        {Icon && (
          ...
          >
            <Icon
              className={cn('w-5 h-5 transition-transform duration-300', isHovered && 'scale-110')}
...
function MiniSparkline({ data, color = 'hsl(var(--primary))', className }: MiniSparklineProps) {
  ...
  return (
    ...
    >
      ...
      {/* Fill region */}
      <path d={`${pathD} L 100,100 L 0,100 Z`} fill={`url(#sparkline-gradient-${color})`} />
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-sm font-semibold text-foreground">
          {typeof value === 'number' ? <AnimatedCounter value={value} duration={800} /> : value}
        </p>
      </div>

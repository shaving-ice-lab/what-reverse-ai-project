...
export function StatCard({
  ...
  return (
    ...
    >
      ...
      {changeLabel && <p className="text-[11px] text-foreground-muted mt-2">{changeLabel}</p>}
    </div>
  )
}
...
export function MiniStatCard({
  ...
  return (
    <div className={cn('p-4 rounded-lg bg-surface-100 border border-border', className)}>
...
export function ProgressStatCard({
  ...
  return (
    <div className={cn('p-5 rounded-lg bg-surface-100 border border-border', className)}>
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          {Icon && (
      ...
      {showPercentage && (
        <p className="text-[11px] text-foreground-muted mt-2">{percentage.toFixed(1)}% used</p>
      )}
    </div>
  )
}
      ...
      <div className="flex items-end justify-between">
        <div>
          ...
          <p className="text-[11px] text-foreground-muted mt-1">
            on: {previousValue.toLocaleString()}
            {unit}
          </p>
        </div>
...
export function LiveStatCard({
  ...
  return (
    ...
    >
      ...
      {subtitle && <p className="text-[11px] text-foreground-muted mt-2">{subtitle}</p>}
    </div>
  )
}

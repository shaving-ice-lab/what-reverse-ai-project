...
const onboardingSteps: OnboardingStep[] = [
  {
    ...
    description: "我们将帮助你快速了解平台的核心功能，只需几分钟即可开始创建你的第一个 AI 工作流。",
    icon: Rocket,
    position: "center",
  },
  {
    id: "stats",
    title: "数据概览",
    description: "这里展示了你的工作流运行状态、成功率和执行时间等关键指标。让你随时掌握系统运行情况。",
    icon: Target,
  ...
  },
  {
    id: "quick-actions",
    title: "快速开始",
    description: "通过这些入口，你可以快速创建新工作流、浏览模板库或查看文档。",
    icon: Zap,
  ...
  },
  {
    id: "workflows",
    title: "最近工作流",
    description: "在这里查看和管理你最近使用的工作流，可以直接运行、编辑或复制它们。",
    icon: Layers,
  ...
  },
  {
    id: "complete",
    title: "准备就绪！",
    description: "太棒了！你已经了解了基本功能。现在可以开始创建你的第一个 AI 工作流了。",
    icon: CheckCircle2,
    position: "center",
    action: {
      label: "创建我的第一个工作流",
...
export function OnboardingGuide({ isOpen, onClose, onComplete }: OnboardingGuideProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100]">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                步骤 <span className="text-primary font-medium">{currentStep + 1}</span> / {onboardingSteps.length}
              </p>
            </div>
          </div>
          <button
      ...
      {/* 帮助提示 - 增强版 */}
      <div className="fixed bottom-6 left-6 flex items-center gap-3 px-4 py-2.5 rounded-xl bg-muted/50 backdrop-blur-sm ring-1 ring-border text-sm text-muted-foreground">
...
export function OnboardingTrigger({ onClick, className }: OnboardingTriggerProps) {
  return (
    ...
    >
      ...
      <span className="relative font-medium">新手引导</span>

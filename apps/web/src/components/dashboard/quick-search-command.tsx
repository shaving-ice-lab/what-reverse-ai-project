...
const recentItems: SearchResult[] = [
  {
    ...
    icon: '🤖',
    type: 'workflow',
    description: 'Use AI to reply to customer issues',
    lastAccess: new Date(),
  },
  {
    id: '2',
  ...
  {
    id: '3',
    name: 'Email category assistant',
    icon: '📧',
    type: 'workflow',
    description: 'Auto-categorize and mark email',
...
const allWorkflows: SearchResult[] = [
  ...recentItems,
  {
    ...
    icon: '✨',
    type: 'workflow',
    description: 'Batch generate marketing copy',
  },
  {
    id: '5',
    ...
    icon: '📊',
    type: 'workflow',
    description: 'Auto-generate data analytics report',
  },
  {
    id: '6',
  ...
  },
  {
    ...
    icon: '🛒',
    type: 'workflow',
    description: 'Auto-process e-commerce orders',
  },
]
      ...
      <div className="relative w-full max-w-xl bg-card/95 backdrop-blur-xl border border-border/50 rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 ring-1 ring-white/5">
        ...
        <div className="flex items-center gap-3 px-4 border-b border-border/50 bg-gradient-to-r from-primary/5 via-transparent to-violet-500/5">
          ...
          <div className="flex items-center gap-1 text-xs text-muted-foreground">
            <kbd className="px-2 py-1 rounded-md bg-muted/50 font-mono text-[10px] ring-1 ring-border/50">
              ESC
            </kbd>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between px-4 py-3 border-t border-border/50 bg-gradient-to-r from-muted/30 via-transparent to-muted/30 text-xs text-muted-foreground">
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1.5">
              <kbd className="px-1.5 py-0.5 rounded-md bg-muted/50 font-mono text-[10px] ring-1 ring-border/50">
                ↑↓
              </kbd>

...
/**
 * CommandPanelQuickSearchComponent
 * 
 * allSearchWorkflow(Cmd+K), RecentAccess+FavoriteList, QuickAction(Run/Edit/Copy)
 */
...
const recentItems: SearchResult[] = [
 { id: "1", name: "SupportAutoReply", icon: "🤖", type: "workflow", description: "Usage AI AutoReplyCustomerIssue", lastAccess: new Date() },
 { id: "2", name: "DataSyncTask", icon: "🔄", type: "workflow", description: "eachdayAutoSyncData", lastAccess: new Date(Date.now() - 3600000) },
 { id: "3", name: "EmailCategoryAssistant", icon: "📧", type: "workflow", description: "AutoCategoryandMarkEmail", lastAccess: new Date(Date.now() - 7200000) },
];

const favoriteItems: SearchResult[] = [
 { id: "1", name: "SupportAutoReply", icon: "🤖", type: "workflow", isFavorite: true },
 { id: "4", name: "ContentGenerate", icon: "✨", type: "workflow", isFavorite: true },
];

const quickActions: SearchResult[] = [
 { id: "new", name: "CreatenewWorkflow", icon: "", type: "action", href: "/dashboard/workflows/new" },
 { id: "templates", name: "BrowseTemplate", icon: "", type: "action", href: "/dashboard/template-gallery" },
 { id: "docs", name: "ViewDocument", icon: "", type: "action", href: "/docs" },
 { id: "settings", name: "Settings", icon: "", type: "action", href: "/dashboard/settings" },
];

const allWorkflows: SearchResult[] = [
 ...recentItems,
 { id: "4", name: "ContentGenerate", icon: "✨", type: "workflow", description: "BatchGenerateMarketing Copy" },
 { id: "5", name: "DataAnalyticsReport", icon: "📊", type: "workflow", description: "AutoGenerateDataAnalyticsReport" },
 { id: "6", name: "Social MediaMonitor", icon: "📱", type: "workflow", description: "Real-timeMonitorSocial Mediaand" },
 { id: "7", name: "OrderProcessFlow", icon: "🛒", type: "workflow", description: "AutoProcessE-commerceOrder" },
];
...
export function QuickSearchCommand({ isOpen, onClose }: QuickSearchCommandProps) {
 ...
 {/* SearchPanel - EnhancedvisualEffect */}
 ...
 placeholder="SearchWorkflow, TemplateorExecuteAction..."
 ...
 SearchResult
 <span className="ml-auto text-primary">{searchResults.length} </span>
 </div>
 ...
 <p className="text-sm font-medium text-muted-foreground">NotoMatch'sResult</p>
 <p className="text-xs text-muted-foreground/60 mt-1">TryUsagenot'sKeywordsSearch</p>
 </div>
 )}
 </div>
 )}
 ...
 <span className="text-muted-foreground/60">OpenSearch</span>
 </div>
 </div>

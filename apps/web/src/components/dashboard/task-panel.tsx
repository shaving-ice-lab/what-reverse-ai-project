...
export function TaskPanel({ className }: TaskPanelProps) {
  ...
  return (
    <Card
      className={cn(
        'border border-border/60 bg-card/80 backdrop-blur-sm overflow-hidden hover:border-orange-500/20 transition-colors duration-300',
        className
      )}
    >
      {/* Header */}
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              ...
              {scheduledCount > 0 && <span>{scheduledCount} pending</span>}
          ...
          >
            ...
            {tab === 'failed' && (
              <span className="flex items-center gap-1.5">
                ...
                Failed{' '}
                {failedCount > 0 && (
                  <span className="px-1.5 py-0.5 rounded-full bg-red-500/20 text-[10px] font-bold">
                    {failedCount}
                  </span>
                )}
              </span>
            ...
            {tab === 'scheduled' && (
              <span className="flex items-center gap-1.5">
                ...
                Plan{' '}
                {scheduledCount > 0 && (
                  <span className="px-1.5 py-0.5 rounded-full bg-blue-500/20 text-[10px] font-bold">
                    {scheduledCount}
                  </span>
                )}
              </span>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                >
                  ...
                  {task.status === 'scheduled' && <Clock className="w-5 h-5 text-blue-500" />}

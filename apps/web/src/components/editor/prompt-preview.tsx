...
export function PromptPreview({
  ...
  return (
    <Collapsible
      ...
      className={cn('rounded-lg border border-border bg-surface-100', className)}
    >
...
export function HTTPPreview({ method, url, headers = {}, body, className }: HTTPPreviewProps) {
  const [isOpen, setIsOpen] = useState(true)
  const [copied, setCopied] = useState(false)

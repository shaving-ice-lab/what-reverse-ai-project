...
const operators = [
  ...
  { value: "notContains", label: "不包含", symbol: "∌" },
  { value: "startsWith", label: "开头是", symbol: "^" },
  { value: "endsWith", label: "结尾是", symbol: "$" },
  { value: "matches", label: "匹配正则", symbol: "~" },
  { value: "empty", label: "为空", symbol: "∅" },
  { value: "notEmpty", label: "非空", symbol: "≠∅" },
];

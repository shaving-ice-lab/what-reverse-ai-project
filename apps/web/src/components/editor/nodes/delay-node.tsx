      ...
      <div className="px-3 py-2.5 space-y-2">
        {isRandom ? (
          ...
          <div className="flex items-center gap-2 p-2 rounded-md bg-surface-200">
            ...
            <span className="font-mono text-base font-semibold">{formatDuration(duration)}</span>
          </div>
        )}
        ...
        <span
          className={cn(
            ...
            isRandom ? 'bg-warning-200 text-warning' : 'bg-surface-200 text-foreground-muted'
          )}
        >

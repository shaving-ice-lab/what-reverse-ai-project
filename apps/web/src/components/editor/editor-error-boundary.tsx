...
const getRecoveryKey = (workflowId?: string) => `agentflow_recovery_${workflowId || 'new'}`
...
> {
  ...
  handleRetry = () => {
    ...
    if (recoveryAttempts < MAX_RECOVERY_ATTEMPTS) {
      ...
      alert(
        'Failed to recover after multiple attempts. Please refresh the page. Your data has been auto-saved.'
      )
    }
  }
          ...
          <div className="w-full max-w-md p-6 rounded-lg border border-border bg-surface-100">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <Button onClick={this.handleReset} variant="outline" className="text-destructive">

...
const inputStyles =
  'bg-surface-200/80 border-border/70 text-foreground placeholder:text-foreground-muted focus:border-brand-500 focus:ring-1 focus:ring-brand-500/20 transition-colors'
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Select value={inputType} onValueChange={(value) => updateConfig('inputType', value)}>
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          onChange={(e) =>
            updateConfig('maxLength', e.target.value === '' ? undefined : Number(e.target.value))
          }
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        <p className="text-xs text-foreground-muted">
          Configure conditions. When satisfied, the True branch executes; otherwise, the False
          branch executes.
        </p>
      </div>
      <ConditionBuilder
    ...
    <div className="space-y-4">
      ...
      {config.mode === 'forEach' && (
        <div className="space-y-2">
          ...
          />
          <p className="text-xs text-foreground-muted">Input must be an array variable</p>
        </div>
      )}
      ...
      <div className="space-y-2">
        ...
        />
        <p className="text-xs text-foreground-muted">Prevent infinite loops (security limit)</p>
      </div>
    </div>
  )
}
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-1.5">
        ...
        <div className="text-xs text-foreground-muted">{operation.toUpperCase()}</div>
      </div>
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="text-center max-w-[200px]">
            ...
            <p className="text-xs text-foreground-muted leading-relaxed">
              Click a node on the canvas to view and edit its config.
            </p>
          </div>
        </div>
      </aside>
  ...
  return (
    <aside className="w-full h-full bg-transparent flex flex-col">
      ...
      <ScrollArea className="flex-1">
        ...
        <ConfigSection title="Node Configuration" icon={<Zap className="w-3.5 h-3.5" />}>

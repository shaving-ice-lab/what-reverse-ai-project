      ...
      <div className="overflow-y-auto" style={{ height: panelHeight }}>
        {activeTab === 'output' && (
          <div className="p-4 font-mono text-xs text-foreground leading-normal">
            ...
            {(!currentExecution ||
              currentExecution.logs.filter((l) => l.level === 'info').length === 0) && (
        ...
        {activeTab === 'logs' &&
          (logs.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full py-8 text-center">
              ...
              <p className="text-xs text-foreground-muted/70 mt-1">
                Runtime logs will be displayed here.
              </p>
            </div>
          ) : (
            <VirtualScrollArea
          ...
          <div className="p-3 font-mono text-xs">
            {currentExecution?.nodes && Object.keys(currentExecution.nodes).length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center h-full py-8 text-center">
                ...
                <p className="text-xs text-foreground-muted/70 mt-1">
                  Node execution data will be displayed here.
                </p>
              </div>
            )}
          </div>

...
type WorkspaceDBRoleRepository interface {
	...
	GetActiveByWorkspaceRole(ctx context.Context, workspaceID uuid.UUID, roleType string) (*entity.WorkspaceDBRole, error)
...
func (r *workspaceDBRoleRepository) GetActiveByWorkspaceRole(ctx context.Context, workspaceID uuid.UUID, roleType string) (*entity.WorkspaceDBRole, error) {
